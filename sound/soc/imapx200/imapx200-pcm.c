...
extern struct snd_soc_device imapx200_snd_devdata;
extern struct platform_device *imapx200_snd_device;
...
struct snd_soc_platform_driver imapx200_soc_platform = {
	.name		= "imapx200-audio",
	.ops 	= &imapx200_pcm_ops,
...
static int __init imapx200_soc_platform_init(void)
{
	...
	return snd_soc_register_platform(imapx200_snd_devdata.dev, &imapx200_soc_platform);
}
module_init(imapx200_soc_platform_init);

static void __exit imapx200_soc_platform_exit(void)
{
	snd_soc_unregister_platform(imapx200_snd_devdata.dev);
}
