...
struct snd_soc_device imapx200_snd_devdata = {
	.card = &imapx200,
//	.platform = &s3c24xx_soc_platform,
	.codec_dev = &soc_codec_dev_rt5621,
	.codec_data = &imapx200_rt5621_setup,
};
EXPORT_SYMBOL(imapx200_snd_devdata);

struct platform_device *imapx200_snd_device;
EXPORT_SYMBOL(imapx200_snd_device);
