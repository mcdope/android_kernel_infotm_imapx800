...
/*  Register Offsets */
#define IMAPX800_PCM_CFG            0x00  
#define IMAPX800_PCM_CTL            0x04
#define IMAPX800_PCM_CLKCTL         0x08
#define IMAPX800_PCM_MCLK_CFG       0x0c
#define IMAPX800_PCM_BCLK_CFG       0x10
#define IMAPX800_PCM_TXFIFO         0x14
#define IMAPX800_PCM_RXFIFO         0x18
#define IMAPX800_PCM_IRQ_CTL        0x1c
#define IMAPX800_PCM_IRQ_STAT       0x20
#define IMAPX800_PCM_FIFO_STAT      0x24
#define IMAPX800_PCM_CLRINT         0x28

#define IMAPX800_PCM_SYNC_NUM    0
...
struct imapx800_pcm_info {
    spinlock_t lock;
    struct device   *dev;
    void __iomem    *regs;
    struct clk  *extclk;
    struct imapx800_pcm_dma_params  *dma_playback;
    struct imapx800_pcm_dma_params  *dma_capture;
