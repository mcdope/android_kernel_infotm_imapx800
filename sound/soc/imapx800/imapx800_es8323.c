/********************************************************************************
** linux-2.6.28.5/sound/soc/imapx800/imapx800_es8323.c
**
...
//	iisclk_dev = (imapx800_IIS_CLK - );
	...
	ret = codec_dai->driver->ops->set_sysclk(codec_dai, ES8323_MCLK, pll_out,
		SND_SOC_CLOCK_IN);
	if (ret < 0)
	...
	ret = codec_dai->driver->ops->set_clkdiv(codec_dai, ES8323_BCLKDIV, bclk);
	if (ret < 0)
		{ printk("aaa4\n");
		return ret;
		}
...
static const struct snd_kcontrol_new es8323_imapx800_controls[] = {
#if 0
 ...
 */
static int imapx800_es8323_init(struct snd_soc_pcm_runtime *rtd)
{
...
//	set_scenario_endpoints(codec, imapx800_AUDIO_OFF);
	...
	snd_soc_add_controls(codec, es8323_imapx800_controls,
				ARRAY_SIZE(es8323_imapx800_controls));
