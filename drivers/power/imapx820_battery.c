...
static int __init imap_bat_init(void)
{
	...
	if(item_exist("pmu.model")) 
	{
	    	...
	    	{
        	    	BATT_DBG("********** PMU is axp202, iMAPX820_BATTERY Driver Not install **********\n");
			return 0;
        	}
    	}
	...
	if(item_exist("charger.pattern"))
	{
		...
		{
		    	BATT_DBG("********** PMU is tps65910 or axp152, but charger.pattern is noFGmode2, Imapx820_battery Driver is not run!\n");
			return 0;
		}
	}
