...
*/
#define AXP_DCDC2_VALUE		1400
/*
	DCDC3：
		AXP20:700~3500，25/step
		AXP19:700~3500，25/step
*/
#define AXP_DCDC3_VALUE		1250

/*电池容量，mAh：根据实际电池容量来定义，对库仑计方法来说这个参数很重要，必须配置*/
#define BATCAP				((item_exist("batt.cap"))?(item_integer("batt.cap", 0)):(2300))
//#define BATCAP              2300

/*初始化电池内阻，mΩ：一般在100~200之间，不过最好根据实际测试出来的确定，方法是打开打印信息，不接电池烧好固件后，上电池，不接充电器，开机，开机1分钟后，接上充电器，充1~2分钟，看打印信息中的rdc值，填入这里*/
#define BATRDC              ((item_exist("batt.rdc"))?(item_integer("batt.rdc", 0)):(186))
//#define BATRDC				120
/*开路电压方法中的电池电压的缓存*/
...
/*
	...
	AXP20，19都适用
*/
#define OCVREG0				0   //0   //0   //0x00		//3.1328
#define OCVREG1				0   //0   //0   //0x01		//3.2736
#define OCVREG2				0   //0   //1   //0x02		//3.4144
#define OCVREG3				0   //5   //4   //0x05		//3.5552
#define OCVREG4				5   //14  //9   //0x07		//3.6256
#define OCVREG5				15  //16  //11  //0x0D		//3.6608
#define OCVREG6				20  //20  //14  //0x10		//3.6960
#define OCVREG7				26  //26  //17  //0x1A		//3.7312
#define OCVREG8				36  //36  //26  //0x24		//3.7664
#define OCVREG9				47  //47  //34  //0x2E		//3.8016
#define OCVREGA				53  //53  //44  //0x35		//3.8368
#define OCVREGB				62  //62  //53  //0x3D		//3.8720
#define OCVREGC				73  //73  //67  //0x49		//3.9424
#define OCVREGD				84  //84  //78  //0x54		//4.0128
#define OCVREGE				92  //92  //87  //0x5C		//4.0832
#define OCVREGF				100 //100 //95  //0x64		//4.1536
...
#define AXP_NOTIFIER_ON			(AXP_IRQ_USBRE |\
							AXP_IRQ_USBOV |\
							AXP_IRQ_ACRE |\
							AXP_IRQ_ACOV |\
							AXP_IRQ_CHAOV |\
...
#define BATT_VOL_OPT    ((item_exist("batt.vol_opt")&&(item_integer("batt.vol_opt", 0)==1))?1:0)
