...
imapfb_fimd_info_t imapfb_fimd = {
	...
	.lcdcon5 = (CONFIG_RGB_ORDER<< 24) | IMAP_LCDCON5_INVVCLK_FALLING_EDGE | IMAP_LCDCON5_INVVLINE_INVERTED | IMAP_LCDCON5_INVVFRAME_INVERTED | IMAP_LCDCON5_INVVD_NORMAL
