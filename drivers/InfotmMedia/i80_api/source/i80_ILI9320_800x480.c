...
** 
** Description: Implementation file of i80 ILI9320 controller 
**
** Author:
...
#define INFOHEAD	"ILI9320_I:"
#define WARNHEAD	"ILI9320_W:"
#define ERRHEAD		"ILI9320_E:"
#define TIPHEAD		"ILI9320_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

i80c_config_t ILI9320_I80C_CONF = {
	{
	...
	,
		.INTMASK =1,								// i80 frame end 中断使能标志  00: No interrup	01: Frame over 10: Normal CMD over 11: Frame over and Normal CMD over
		.Main_lcd = 0 ,
		.Data_format = 0x180,
		{
			{ 0,0,0, },
...
I80_Priv_conf ILI9320_PRIV_CONF = {
	.block[0] = {
	...
	.block[1] = {
		I80_MANU_RGB, 	// firstly MCU send command or data,transform to RGB data , i80 controller open 
		10, 		// sleep time after controller open, in ms
		(void *)&ILI9320_I80C_CONF,
		IM_NULL,
	},
	.block[2] = {
