 ...
 */
void mipi_dsih_write_word(dsih_ctrl_t * instance, IM_UINT32 reg_address, IM_UINT32 data)
{
 ...
 */
void mipi_dsih_write_part(dsih_ctrl_t * instance, IM_UINT32 reg_address, IM_UINT32 data, IM_UINT8 shift, IM_UINT8 width)
{
	IM_UINT32 mask = (1 << width) - 1;
	IM_UINT32 temp = mipi_dsih_read_word(instance, reg_address);
 ...
 */
IM_UINT32 mipi_dsih_read_word(dsih_ctrl_t * instance, IM_UINT32 reg_address)
{
 ...
 */
IM_UINT32 mipi_dsih_read_part(dsih_ctrl_t * instance, IM_UINT32 reg_address, IM_UINT8 shift, IM_UINT8 width)
{
 ...
 */
IM_UINT32 mipi_dsih_hal_get_version(dsih_ctrl_t * instance)
{
 ...
 * @param on (1) or off (0)
 */
void mipi_dsih_hal_power(dsih_ctrl_t * instance, IM_INT32 on)
{
 ...
 * @return power status
 */
IM_INT32 mipi_dsih_hal_get_power(dsih_ctrl_t * instance)
{
 ...
 */
void mipi_dsih_hal_tx_escape_timeout(dsih_ctrl_t * instance, IM_UINT8 tx_escape_division)
{
 ...
 */
void mipi_dsih_hal_dpi_video_vc(dsih_ctrl_t * instance, IM_UINT8 vc)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DPI_CFG, (IM_UINT32)(vc), 0, 2);
}
/**
 ...
 */
IM_UINT8 mipi_dsih_hal_dpi_get_video_vc(dsih_ctrl_t * instance)
{
 ...
 */
IM_UINT8 mipi_dsih_hal_dpi_get_color_depth(dsih_ctrl_t * instance)
{
	IM_UINT8 color_depth = 0;
 ...
 */
IM_UINT8 mipi_dsih_hal_dpi_get_color_config(dsih_ctrl_t * instance)
{
	IM_UINT8 color_config = 0;
	switch (mipi_dsih_read_part(instance, R_DSI_HOST_DPI_CFG, 2, 3))
	{
		case 0:
			color_config = 1;
 ...
 * @param enable
 */
void mipi_dsih_hal_dpi_18_loosely_packet_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 */
void mipi_dsih_hal_dpi_color_mode_pol(dsih_ctrl_t * instance, IM_INT32 active_low)
{
 ...
 * @param active_low (1) or active high (0)
 */
void mipi_dsih_hal_dpi_shut_down_pol(dsih_ctrl_t * instance, IM_INT32 active_low)
{
 ...
 * @param active_low (1) or active high (0)
 */
void mipi_dsih_hal_dpi_hsync_pol(dsih_ctrl_t * instance, IM_INT32 active_low)
{
 ...
 * @param active_low (1) or active high (0)
 */
void mipi_dsih_hal_dpi_vsync_pol(dsih_ctrl_t * instance, IM_INT32 active_low)
{
 ...
 * @param active_low (1) or active high (0)
 */
void mipi_dsih_hal_dpi_dataen_pol(dsih_ctrl_t * instance, IM_INT32 active_low)
{
 ...
 */
void mipi_dsih_hal_dpi_frame_ack_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_null_packet_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_multi_packet_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_hfp(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_hbp(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_vactive(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_vfp(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_vbp(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_lp_during_vsync(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_dpi_video_mode_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @return status
 */
IM_INT32 mipi_dsih_hal_dpi_is_video_mode(dsih_ctrl_t * instance)
{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_dpi_null_packet_size(dsih_ctrl_t * instance, IM_UINT16 size)
{
 ...
 * @param no of chunks
 */
dsih_error_t mipi_dsih_hal_dpi_chunks_no(dsih_ctrl_t * instance, IM_UINT16 no)
{
	if (no < 0x3ff)
	{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_dpi_video_packet_size(dsih_ctrl_t * instance, IM_UINT16 size)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_tear_effect_ack_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable (1) - disable (0)
 */
void mipi_dsih_hal_cmd_ack_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_dcs_wr_tx_type(dsih_ctrl_t * instance, IM_UINT32 no_of_param, IM_INT32 lp)
{
	switch (no_of_param)
	{
		case 0:
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_dcs_rd_tx_type(dsih_ctrl_t * instance, IM_UINT32 no_of_param, IM_INT32 lp)
{
	dsih_error_t err = DSI_OK;
	switch (no_of_param)
	{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_gen_wr_tx_type(dsih_ctrl_t * instance, IM_UINT32 no_of_param, IM_INT32 lp)
{
	switch (no_of_param)
	{
		case 0:
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_gen_rd_tx_type(dsih_ctrl_t * instance, IM_UINT32 no_of_param, IM_INT32 lp)
{
	dsih_error_t err = DSI_OK;
	switch (no_of_param)
	{
 ...
 */
void mipi_dsih_hal_max_rd_size_tx_type(dsih_ctrl_t * instance, IM_INT32 lp)
{
 ...
 * @param enable
 */
void mipi_dsih_hal_gen_cmd_mode_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 */
IM_INT32 mipi_dsih_hal_gen_is_cmd_mode(dsih_ctrl_t * instance)
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_CMD_MODE_CFG, 0, 1);
}
//sam :
IM_INT32 mipi_dsih_hal_gen_is_video_mode(dsih_ctrl_t * instance)
{
	return mipi_dsih_read_part(instance, R_DSI_HOST_VID_MODE_CFG, 0, 1);
}
 ...
 */
void mipi_dsih_hal_dpi_hline(dsih_ctrl_t * instance, IM_UINT16 time)
{
 ...
 */
void mipi_dsih_hal_dpi_hbp(dsih_ctrl_t * instance, IM_UINT16 time)
{
 ...
 */
void mipi_dsih_hal_dpi_hsa(dsih_ctrl_t * instance, IM_UINT16 time)
{
 ...
 * @param lines
 */
void mipi_dsih_hal_dpi_vactive(dsih_ctrl_t * instance, IM_UINT16 lines)
{
 ...
 * @param lines
 */
void mipi_dsih_hal_dpi_vfp(dsih_ctrl_t * instance, IM_UINT16 lines)
{
 ...
 * @param lines
 */
void mipi_dsih_hal_dpi_vbp(dsih_ctrl_t * instance, IM_UINT16 lines)
{
 ...
 * @param lines
 */
void mipi_dsih_hal_dpi_vsync(dsih_ctrl_t * instance, IM_UINT16 lines)
{
 ...
 */
void mipi_dsih_hal_timeout_clock_division(dsih_ctrl_t * instance, IM_UINT8 byte_clk_division_factor)
{
 ...
 */
void mipi_dsih_hal_lp_rx_timeout(dsih_ctrl_t * instance, IM_UINT16 count)
{
 ...
 */
void mipi_dsih_hal_hs_tx_timeout(dsih_ctrl_t * instance, IM_UINT16 count)
{
 ...
 */
IM_UINT32 mipi_dsih_hal_error_status_0(dsih_ctrl_t * instance, IM_UINT32 mask)
{
 ...
 */
IM_UINT32 mipi_dsih_hal_error_status_1(dsih_ctrl_t * instance, IM_UINT32 mask)
{
 ...
 */
void mipi_dsih_hal_error_mask_0(dsih_ctrl_t * instance, IM_UINT32 mask)
{
 ...
 */
IM_UINT32 mipi_dsih_hal_get_error_mask_0(dsih_ctrl_t * instance, IM_UINT32 mask)
{
 ...
 */
void mipi_dsih_hal_error_mask_1(dsih_ctrl_t * instance, IM_UINT32 mask)
{
 ...
 * @param mask the bits to read from the mask register
 */
IM_UINT32 mipi_dsih_hal_get_error_mask_1(dsih_ctrl_t * instance, IM_UINT32 mask)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_ERROR_MSK1) & mask);
}

//sam : add dbi implement
#if 1
void mipi_dsih_hal_dbi_out_color_coding(dsih_ctrl_t * instance, IM_UINT8 color_depth, IM_UINT8 option)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CFG, color_depth, 9, 4);
}
void mipi_dsih_hal_dbi_in_color_coding(dsih_ctrl_t * instance, IM_UINT8 color_depth, IM_UINT8 option)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CFG, color_depth, 2, 4);
}
void mipi_dsih_hal_dbi_lut_size(dsih_ctrl_t * instance, IM_UINT8 size)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CFG, size, 6, 2);
}
void mipi_dsih_hal_dbi_partitioning_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CFG, enable, 8, 1);
}
void mipi_dsih_hal_dbi_dcs_vc(dsih_ctrl_t * instance, IM_UINT8 vc)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CFG, vc, 0, 2);
}
void mipi_dsih_hal_dbi_max_cmd_size(dsih_ctrl_t * instance, IM_UINT16 size)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CMDSIZE, size, 16, 16);
}
void mipi_dsih_hal_dbi_cmd_size(dsih_ctrl_t * instance, IM_UINT16 size)
{
	mipi_dsih_write_part(instance, R_DSI_HOST_DBI_CMDSIZE, size, 0, 16);
}
IM_INT32 mipi_dsih_hal_dbi_rd_cmd_busy(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x4000);
}
IM_INT32 mipi_dsih_hal_dbi_read_fifo_full(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x2000);
}
IM_INT32 mipi_dsih_hal_dbi_read_fifo_empty(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x1000);
}
IM_INT32 mipi_dsih_hal_dbi_write_fifo_full(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x800);
}
IM_INT32 mipi_dsih_hal_dbi_write_fifo_empty(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x400);
}
IM_INT32 mipi_dsih_hal_dbi_cmd_fifo_full(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x200);
}
IM_INT32 mipi_dsih_hal_dbi_cmd_fifo_empty(dsih_ctrl_t * instance)
{
	return (mipi_dsih_read_word(instance, R_DSI_HOST_CMD_PKT_STATUS) & 0x100);
}
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_gen_packet_header(dsih_ctrl_t * instance, IM_UINT8 vc, IM_UINT8 packet_type, IM_UINT8 ms_byte, IM_UINT8 ls_byte)
{
	if (vc < 4)
	{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_hal_gen_packet_payload(dsih_ctrl_t * instance, IM_UINT32 payload)
{
 ...
 * @return error code
 */
dsih_error_t  mipi_dsih_hal_gen_read_payload(dsih_ctrl_t * instance, IM_UINT32* payload)
{
 ...
 */
void mipi_dsih_hal_gen_rd_vc(dsih_ctrl_t * instance, IM_UINT8 vc)
{
 ...
 * @param enable
 */
void mipi_dsih_hal_gen_eotp_rx_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable
 */
void mipi_dsih_hal_gen_eotp_tx_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable
 */
void mipi_dsih_hal_bta_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable
 */
void mipi_dsih_hal_gen_ecc_rx_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @param enable
 */
void mipi_dsih_hal_gen_crc_rx_en(dsih_ctrl_t * instance, IM_INT32 enable)
{
 ...
 * @return 1 if busy
 */
IM_INT32 mipi_dsih_hal_gen_rd_cmd_busy(dsih_ctrl_t * instance)
{
 ...
 */
IM_INT32 mipi_dsih_hal_gen_read_fifo_full(dsih_ctrl_t * instance)
{
 ...
 */
IM_INT32 mipi_dsih_hal_gen_read_fifo_empty(dsih_ctrl_t * instance)
{
 ...
 * @return 1 if fifo full
 */
IM_INT32 mipi_dsih_hal_gen_write_fifo_full(dsih_ctrl_t * instance)
{
 ...
 * @return 1 if fifo empty
 */
IM_INT32 mipi_dsih_hal_gen_write_fifo_empty(dsih_ctrl_t * instance)
{
 ...
 * @return 1 if fifo full
 */
IM_INT32 mipi_dsih_hal_gen_cmd_fifo_full(dsih_ctrl_t * instance)
{
 ...
 * @return 1 if fifo empty
 */
IM_INT32 mipi_dsih_hal_gen_cmd_fifo_empty(dsih_ctrl_t * instance)
{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_phy_hs2lp_config(dsih_ctrl_t * instance, IM_UINT8 no_of_byte_cycles)
{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_phy_lp2hs_config(dsih_ctrl_t * instance, IM_UINT8 no_of_byte_cycles)
{
 ...
 * @return error code
 */
dsih_error_t mipi_dsih_phy_bta_time(dsih_ctrl_t * instance, IM_UINT16 no_of_byte_cycles)
{
