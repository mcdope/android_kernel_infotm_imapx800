...
public:
	...
	IM_RET run(IN IM_BOOL wait=IM_FALSE);	// if wait is IM_FALSE, no need reply.
	IM_RET request(IN IM_INT32 cmd, IN void *param, IN IM_BOOL wait=IM_TRUE, IN IM_INT32 timeout=-1, IN IM_BOOL stall=IM_TRUE);
