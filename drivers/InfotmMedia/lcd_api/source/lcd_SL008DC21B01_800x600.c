...
#define INFOHEAD	"SL008DC21B01_I:"
#define WARNHEAD	"SL008DC21B01_W:"
#define ERRHEAD		"SL008DC21B01_E:"
#define TIPHEAD		"SL008DC21B01_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t SL008DC21B01_LCDC_CONF = {
	.width =  800,
	.height = 600,
	.VSPW = 8,
	.VBPD = 20,
...
LCD_Priv_conf SL008DC21B01_PRIV_CONF = {
	.block[0] = {
