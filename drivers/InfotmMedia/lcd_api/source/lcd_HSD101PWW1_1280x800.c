...
#define INFOHEAD		"HSD101PWW1_I:"
#define WARNHEAD		"HSD101PWW1_W:"
#define ERRHEAD			"HSD101PWW1_E:"
#define TIPHEAD			"HSD101PWW1_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t HSD101PWW1_LCDC_CONF = {
	.width =  1280,
	.height = 800,
	.VSPW = 3,
	.VBPD = 10,
...
LCD_Priv_conf HSD101PWW1_PRIV_CONF = {
	.block[0] = {
