...
#define INFOHEAD	"T070SWS057H_I:"
#define WARNHEAD	"T070SWS057H_W:"
#define ERRHEAD		"T070SWS057H_E:"
#define TIPHEAD		"T070SWS057H_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t T070SWS057H_LCDC_CONF = {
	.width =  1024,
	.height = 600,
	.VSPW = 8,
	.VBPD = 13,
...
LCD_Priv_conf T070SWS057H_PRIV_CONF = {
	.block[0] = {
