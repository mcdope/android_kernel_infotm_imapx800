...
#define INFOHEAD	"T70P03_I:"
#define WARNHEAD	"T70P03_W:"
#define ERRHEAD		"T70P03_E:"
#define TIPHEAD		"T70P03_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t T70P03_LCDC_CONF = {
	.width =  1024,
	.height = 600,
	.VSPW = 3,
	.VBPD = 15,
...
LCD_Priv_conf T70P03_PRIV_CONF = {
	.block[0] = {
