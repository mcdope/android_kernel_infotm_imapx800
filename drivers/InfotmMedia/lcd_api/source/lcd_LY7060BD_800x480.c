...
#define INFOHEAD	"LY7060BD_I:"
#define WARNHEAD	"LY7060BD_W:"
#define ERRHEAD		"LY7060BD_E:"
#define TIPHEAD		"LY7060BD_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t LY7060BD_LCDC_CONF = {
	.width =  800,
	.height = 480,
	.VSPW = 8,
	.VBPD = 23,
...
LCD_Priv_conf LY7060BD_PRIV_CONF = {
	.block[0] = {
