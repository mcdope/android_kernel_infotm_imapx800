...
#define INFOHEAD	"RS3WSN70040A_I:"
#define WARNHEAD	"RS3WSN70040A_W:"
#define ERRHEAD		"RS3WSN70040A_E:"
#define TIPHEAD		"RS3WSN70040A_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t RS3WSN70040A_LCDC_CONF = {
	.width =  1024,
	.height = 600,
	.VSPW = 8,
	.VBPD = 15,
...
LCD_Priv_conf RS3WSN70040A_PRIV_CONF = {
	.block[0] = {
