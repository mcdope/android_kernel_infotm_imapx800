...
** Revision History: 
** ----------------- 
** 1.0.1	 Sam@2012/09/18 :  first commit
**
*****************************************************************************/
...
#define INFOHEAD	"LXJC070NDM350_18C2_I:"
#define WARNHEAD	"LXJC070NDM350_18C2_W:"
#define ERRHEAD		"LXJC070NDM350_18C2_E:"
#define TIPHEAD		"LXJC070NDM350_18C2_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t LXJC070NDM350_18C2_800x480 = {
	.width =  800,
	.height = 480,
	.VSPW = 3,
	.VBPD = 29,
...
LCD_Priv_conf LXJC070NDM350_PRIV_CONF = {
	.block[0] = {
	...
	.block[1] = {
		...
		(void *)&LXJC070NDM350_18C2_800x480 ,
		IM_NULL,
	},
	.block[2] = {
