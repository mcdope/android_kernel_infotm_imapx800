...
#define INFOHEAD	"HSD070IDW1_I:"
#define WARNHEAD	"HSD070IDW1_W:"
#define ERRHEAD		"HSD070IDW1_E:"
#define TIPHEAD		"HSD070IDW1_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t HSD070IDW1_LCDC_CONF = {
	.width =  800,
	.height = 480,
	.VSPW = 5,
	.VBPD = 34,
...
LCD_Priv_conf HSD070IDW1_PRIV_CONF = {
	.block[0] = {
