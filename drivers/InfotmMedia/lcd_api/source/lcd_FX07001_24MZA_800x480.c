...
#define INFOHEAD	"FX07001_24MZA_I:"
#define WARNHEAD	"FX07001_24MZA_W:"
#define ERRHEAD		"FX07001_24MZA_E:"
#define TIPHEAD	    "FX07001_24MZA_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t FX07001_24MZA_LCDC_CONF = {
	.width =  800,
	.height = 480,
	.VSPW = 3,
	.VBPD = 29,
...
LCD_Priv_conf FX07001_24MZA_PRIV_CONF = {
	.block[0] = {
