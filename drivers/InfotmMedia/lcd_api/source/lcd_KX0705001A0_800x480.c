...
#define INFOHEAD	"KX0705001A0_I:"
#define WARNHEAD	"KX0705001A0_W:"
#define ERRHEAD		"KX0705001A0_E:"
#define TIPHEAD	    "KX0705001A0_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t KX0705001A0_LCDC_CONF = {
	.width =  800,
	.height = 480,
	.VSPW = 3,
	.VBPD = 30,
...
LCD_Priv_conf KX0705001A0_PRIV_CONF = {
	.block[0] = {
