...
#define INFOHEAD	"SHUOYING_N1066_I:"
#define WARNHEAD	"SHUOYING_N1066_W:"
#define ERRHEAD		"SHUOYING_N1066_E:"
#define TIPHEAD		"SHUOYING_N1066_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t SHUOYING_N1066_LCDC_CONF = {
	.width =  1024,
	.height = 600,
	.VSPW = 3,
	.VBPD = 23,
...
LCD_Priv_conf SHUOYING_N1066_PRIV_CONF = {
	.block[0] = {
