...
#define INFOHEAD	"M710C_I:"
#define WARNHEAD	"M710C_W:"
#define ERRHEAD		"M710C_E:"
#define TIPHEAD		"M710C_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t M710C_LCDC_CONF = {
	.width =  1024,
	.height = 600,
	.VSPW = 3,
	.VBPD = 15,
