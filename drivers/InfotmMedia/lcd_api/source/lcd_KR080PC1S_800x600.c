...
#define INFOHEAD	"KR080PC1S_I:"
#define WARNHEAD	"KR080PC1S_W:"
#define ERRHEAD		"KR080PC1S_E:"
#define TIPHEAD		"KR080PC1S_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t KR080PC1S_LCDC_CONF = {
	.width =  800,
	.height = 600,
	.VSPW = 3,
	.VBPD = 39,
...
LCD_Priv_conf KR080PC1S_PRIV_CONF = {
	.block[0] = {
