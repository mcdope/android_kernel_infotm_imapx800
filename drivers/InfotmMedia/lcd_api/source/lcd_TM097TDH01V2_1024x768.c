...
#define INFOHEAD	"TM097TDH01V2_I:"
#define WARNHEAD	"TM097TDH01V2_W:"
#define ERRHEAD		"TM097TDH01V2_E:"
#define TIPHEAD		"TM097TDH01V2_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t TM097TDH01V2_LCDC_CONF = {
	.width =  1024,
	.height = 768,
	.VSPW = 8,
	.VBPD = 23,
...
LCD_Priv_conf TM097TDH01V2_PRIV_CONF = {
	.block[0] = {
