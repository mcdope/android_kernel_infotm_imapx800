...
#define INFOHEAD	"SL008DH24B01_I:"
#define WARNHEAD	"SL008DH24B01_W:"
#define ERRHEAD		"SL008DH24B01_E:"
#define TIPHEAD		"SL008DH24B01_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t SL008DH24B01_LCDC_CONF = {
	.width =  1024,
	.height = 768,
	.VSPW = 8,
	.VBPD = 20,
...
LCD_Priv_conf SL008DH24B01_PRIV_CONF = {
	.block[0] = {
