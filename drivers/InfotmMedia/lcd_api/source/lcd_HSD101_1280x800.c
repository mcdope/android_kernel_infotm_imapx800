...
#define INFOHEAD	"HSD101IDW1_I:"
#define WARNHEAD	"HSD101IDW1_W:"
#define ERRHEAD		"HSD101IDW1_E:"
#define TIPHEAD		"HSD101IDW1_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t HSD101_LCDC_CONF = {
	.width =  1280,
	.height = 800,
	.VSPW = 5,
	.VBPD = 9,
...
LCD_Priv_conf HSD101_PRIV_CONF = {
	.block[0] = {
