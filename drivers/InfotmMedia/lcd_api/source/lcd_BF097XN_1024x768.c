...
#define INFOHEAD	"BF097XN_I:"
#define WARNHEAD	"BF097XN_W:"
#define ERRHEAD		"BF097XN_E:"
#define TIPHEAD		"BF097XN_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t BF097XN_LCDC_CONF = {
	.width =  1024,
	.height = 768,
	.VSPW = 6,
	.VBPD = 13,
...
LCD_Priv_conf BF097XN_PRIV_CONF = {
	.block[0] = {
