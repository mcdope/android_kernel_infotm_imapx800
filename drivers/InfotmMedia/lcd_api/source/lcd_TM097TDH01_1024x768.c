...
#define INFOHEAD	"TM097TDH01_I:"
#define WARNHEAD	"TM097TDH01_W:"
#define ERRHEAD		"TM097TDH01_E:"
#define TIPHEAD		"TM097TDH01_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t TM097TDH01_LCDC_CONF = {
	.width =  1024,
	.height = 768,
	.VSPW = 8,
	.VBPD = 15,
...
LCD_Priv_conf TM097TDH01_PRIV_CONF = {
	.block[0] = {
