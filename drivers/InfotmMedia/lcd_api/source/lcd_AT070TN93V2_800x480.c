...
#define INFOHEAD	"AT070TN93V2_I:"
#define WARNHEAD	"AT070TN93V2_W:"
#define ERRHEAD		"AT070TN93V2_E:"
#define TIPHEAD	    "AT070TN93V2_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t AT070TN93V2_LCDC_CONF = {
	.width =  800,
	.height = 480,
	.VSPW = 3,
	.VBPD = 20,
...
LCD_Priv_conf AT070TN93V2_PRIV_CONF = {
	.block[0] = {
