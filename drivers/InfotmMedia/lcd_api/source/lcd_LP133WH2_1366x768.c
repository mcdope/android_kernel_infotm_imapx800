...
#define INFOHEAD		"LP133WH2_I:"
#define WARNHEAD		"LP133WH2_W:"
#define ERRHEAD			"LP133WH2_E:"
#define TIPHEAD			"LP133WH2_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t LP133WH2_LCDC_CONF = {
	.width =  1366,
	.height = 768,
	.VSPW = 5,
	.VBPD = 14,
...
LCD_Priv_conf LP133WH2_PRIV_CONF = {
	.block[0] = {
