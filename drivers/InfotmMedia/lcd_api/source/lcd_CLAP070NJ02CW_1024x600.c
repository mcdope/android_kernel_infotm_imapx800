...
#define INFOHEAD	"CLAP070NJ02CW_I:"
#define WARNHEAD	"CLAP070NJ02CW_W:"
#define ERRHEAD		"CLAP070NJ02CW_E:"
#define TIPHEAD		"CLAP070NJ02CW_T:"

static void proc1(void);
static void proc2(void);
static void proc3(void);

lcdc_config_t CLAP070NJ02CW_LCDC_CONF = {
	.width =  1024,
	.height = 600,
	.VSPW = 3,
	.VBPD = 20,
...
LCD_Priv_conf CLAP070NJ02CW_PRIV_CONF = {
	.block[0] = {
