...
static struct ov5640_regval_list  ov5640_init_regs[] = {
    ...
    {0x48, 0x00, 0x04},//0x04--continue clock, 0x24--gate clock/non-continue clock, 0x34--Send line short packet for each line
    //{0x30, 0x2d, 0x30},//Driving strength:0x00/0x10/0x20/0x30
    //mipi reset
    //{0x30, 0x03, 0x03},//
    //{0x30, 0x03, 0x01},//
...
static struct ov5640_regval_list  ov5640_init2_regs[] = {
#if 0
    //@@ YUV_5M_2lane_7.5fps
    //2592x1944
    ...
    {0x48, 0x00, 0x24},//0x04--continue clock, 0x24--gate clock/non-continue clock, 0x34--Send line short packet for each line
    ...
    {0xff, 0xff, 0xc8},//delay 200ms
    {0x30, 0x08, 0x42},//power down
    {0x31, 0x03, 0x03},//select system input clock
#if 1 //MIPI setting
    {0x30, 0x17, 0x00},//DVP output disable
    {0x30, 0x18, 0x00},//DVP output disable
#else //DVP setting
    {0x30, 0x17, 0xff},//mipi output enable
    {0x30, 0x18, 0xff},//mipi output enable
#endif
    ...
    {0x30, 0x02, 0x1c},///
    {0x30, 0x06, 0xc3},///
    {0x30, 0x0e, 0x45},//two lane mode and mipi enable
    {0x30, 0x2e, 0x08},///
    {0x36, 0x12, 0x4b},
    {0x36, 0x18, 0x04},

    //pll and clock setting
    {0x30, 0x34, 0x18},//8-bit mode
#if 0
    {0x30, 0x35, 0x21},
    {0x30, 0x36, 0x54},
    {0x30, 0x37, 0x13},
    ...
    {0x30, 0x08, 0x02},//power down disable
    {0x35, 0x03, 0x00},
