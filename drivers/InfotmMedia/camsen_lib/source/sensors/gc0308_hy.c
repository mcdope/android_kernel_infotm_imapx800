...
#define INFOHEAD	"gc0308_hy_I:"
#define WARNHEAD	"gc0308_hy_W:"
#define ERRHEAD		"gc0308_hy_E:"
#define TIPHEAD		"gc0308_hy_T:"
...
static gc0308_hy_context_t gGc0308;
...
int gc0308_hy_switch_qvga(void){ 
	int i, ret;
...
IM_INT32 gc0308_hy_set_sepia(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_bluish(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_greenish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_reddish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_yellowish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_bandw(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_negative(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_normal(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_auto(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_sunny(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_cloudy(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_office(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_home(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_effect(IM_INT32 value)
{
...
IM_INT32 gc0308_hy_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gc0308_hy_set_night_mode(IM_BOOL enable)
{
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_set_scene_mode(IM_INT32 value)
{
	...
	return gc0308_hy_set_night_mode(nightModeEn);
}

IM_INT32 gc0308_hy_set_exposure(IM_INT32 value)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gc0308_hy_set_antibanding(IM_INT32 value)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
//======================================================
IM_RET gc0308_hy_pwdn(IM_UINT32 padNum)
{
...
IM_RET gc0308_hy_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_INT32 gc0308_hy_repeat_init()
{
    IM_INT32 i, num = 0;
    IM_INT32 ret;
...
IM_RET gc0308_hy_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
    IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_VGA)
	{
		ret = gc0308_hy_switch_vga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc0308_hy_switch_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_QVGA)
	{
		ret = gc0308_hy_switch_qvga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc0308_hy_switch_qvga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_RET gc0308_hy_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops gc0308_hy_ops = {
	.name                   = "gc0308_hy",
	.i2c_dev_addr           = GC0308_I2C_ADDR,

	.sen_pwdn				= gc0308_hy_pwdn,
	.sen_get_pmu_info		= gc0308_hy_get_pmu_info,
	.sen_init				= gc0308_hy_init,
	.sen_deinit				= gc0308_hy_deinit,
	.sen_start				= gc0308_hy_start,
	.sen_stop				= gc0308_hy_stop,
	.sen_get_caps			= gc0308_hy_get_caps,
	.sen_set_out_mode		= gc0308_hy_set_out_mode,
	.sen_get_out_mode		= gc0308_hy_get_out_mode,
	.sen_set_property		= gc0308_hy_set_property,
	.sen_get_property		= gc0308_hy_get_property,
};
