#ifndef __HI253_YUV_H__
#define __HI253_YUV_H__

#define HI253_I2C_ADDR                (0x40>>1)
...
//function delcare
IM_INT32 hi253_yuv_to_preview_640_480(void);

static struct hi253_regval_list {
	IM_UCHAR  reg;
	IM_UCHAR  value;
};
 //preveiw 640*480
#if 0  
static struct hi253_regval_list hi253_init_regs[]={
	{0x01, 0x79},  //sleep on
	{0x08, 0x0f},  //Hi-Z on
	{0x01, 0x78},  //sleep off
	...
	{0x9c, 0x14},  //EXP Limit 488.28 fps 
	{0x9d, 0x00},  
	{0x9e, 0x02},  //EXP Unit 
	{0x9f, 0x00},  
...
{0x39, 0x88},		
{0x50, 0x20},		
{0x51, 0x03}, // 0x00->0x03 [20110915 update]		
{0x52, 0x01},		
{0x53, 0xc1},		
{0x54, 0x10},		
{0x55, 0x1c},		
...
{0x3e, 0x58},
{0x3f, 0x00},	
{0x40, 0x80}, // YOFS modify brightness
{0x41, 0x00}, // DYOFS
{0x48, 0x88}, // contrast
//Saturation;
{0x60, 0x6f}, // SATCTL
{0x61, 0x88}, //7e //8e //88 //80
{0x62, 0x80}, //7e //8e //88 //80
{0x63, 0x41}, //Double_AG 50->30
{0x64, 0x41},	
{0x66, 0x42},
{0x67, 0x20},	
{0x6a, 0xa8}, //ori 0x54
...
{0x72, 0x84}, //SAT_WHT_TH
{0x73, 0x80}, //SAT_WHT_TH2
{0x74, 0x48}, //WHT_OFS
{0x75, 0x60}, //SAT_OVER_TH
{0x76, 0x09}, //SAT_SAT_CTL2
{0x77, 0x00}, //SAT_CTL3
{0x78, 0x00}, //SAT_CTL4
{0x79, 0x08}, //SAT_WHT_OFS1
{0x03, 0x11},
{0x10, 0x7f},
{0x11, 0x40},
{0x12, 0x0a}, // Blue Max-Filter Delete
...
static struct hi253_regval_list  hi253_sw_reset_regs[] = {
	{0x03, 0x00},
	{0x01,0xf1},
	{0x01,0xf3},
	{0x01,0xf1},
...
static struct hi253_regval_list  hi253_uxga_regs[] = {
	{0x03,0x00},
	{0x10,0x00},
};

static struct hi253_regval_list  hi253_svga_regs[] = {
	{0x03,0x00},
	{0x10,0x11},
};
static struct hi253_regval_list  hi253_vga_regs[] = {
...
static struct hi253_regval_list  hi253_brightness_0[]={    
	// Brightness -2	
	{0x03, 0x10}, 	
	{0x40, 0xa0},	
};

static struct hi253_regval_list  hi253_brightness_1[]={   
	// Brightness -1	
	{0x03, 0x10}, 	
	{0x40, 0x90},	
};

static struct hi253_regval_list  hi253_brightness_2[]={   
	//  Brightness 0 	
	{0x03, 0x10}, 	
	{0x40, 0x80},	
};

static struct hi253_regval_list  hi253_brightness_3[]={   
	// Brightness +1	
	{0x03, 0x10}, 	
	{0x40, 0x10},	
};

static struct hi253_regval_list  hi253_brightness_4[]={   
	//  Brightness +2	
	{0x03, 0x10}, 	
	{0x40, 0x20},	
};

static struct hi253_regval_list  hi253_brightness_5[]={    
	//  Brightness +3	
	{0x03, 0x10}, 	
	{0x40, 0x30},	
};
...
static struct hi253_regval_list hi253_auto_regs[]={
	{0x03, 0x22},			
	{0x10, 0xfd},		
	{0x11, 0x2e},		
	{0x83, 0x5e},
...
static struct hi253_regval_list hi253_cloudy_regs[]={//cloudy
...
static struct hi253_regval_list hi253_sunny_regs[]={//sunny
	{0x03, 0x22},
	{0x11, 0x28},		  
	{0x80, 0x59},
	{0x82, 0x29},
...
static struct hi253_regval_list hi253_office_regs[]={//AWB_MODE_INCANDESCENT: //office
...
static struct hi253_regval_list hi253_home_regs[]={//AWB_MODE_TUNGSTEN: //home
	{0x03, 0x22},
	{0x80, 0x24},
	{0x81, 0x20},
	{0x82, 0x58},
...
static struct hi253_regval_list hi253_fluor_regs[]={//AWB_MODE_FLUORESCENT:
	{0x03, 0x22},
	{0x11, 0x28},		  
	{0x80, 0x41},
	{0x82, 0x42},
...
static struct hi253_regval_list hi253_normal_regs[]={//MEFFECT_OFF
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x30},
	{0x13, 0x0a},
...
static struct hi253_regval_list hi253_sepia_regs[]={
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x33},
	{0x13, 0x02},
...
static struct hi253_regval_list hi253_negative_regs[]={//MEFFECT_NEGATIVE:
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x38},
	{0x13, 0x02},
...
static struct hi253_regval_list hi253_greenish_regs[]={//MEFFECT_SEPIAGREEN:
    {0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x33},
	{0x13, 0x02},
...
static struct hi253_regval_list hi253_bluish_regs[]={//MEFFECT_SEPIABLUE:
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x33},
	{0x13, 0x02},
...
static struct hi253_regval_list hi253_mono_regs[]={//MEFFECT_MONO: //B&W
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x33},
	{0x13, 0x02},
...
static struct hi253_regval_list hi253_solar_regs[]={//MEFFECT_SOLARIZE:
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x30},
	{0x13, 0x0a},
...
static struct hi253_regval_list hi253_aqua_regs[]={//MEFFECT_AQUA:
	{0x03, 0x10},
	{0x11, 0x03},
	{0x12, 0x33},
	{0x13, 0x00},
...
static struct hi253_regval_list hi253_black_regs[]={//MEFFFECT_BLACKBOARD:
	{0x03, 0x10},
	{0x11, 0x13},
	{0x12, 0x30},
	{0x13, 0x0a},
...
static struct hi253_regval_list hi253_post_regs[]={//MEFFECT_POSTERIZE:
	{0x03, 0x10},
	{0x11, 0x0b},
	{0x12, 0x30},
	{0x13, 0x00},
...
static struct hi253_regval_list hi253_white_regs[]={//MEFFECT_WHITEBOARD:
	{0x03, 0x10},
	{0x11, 0x13},
	{0x12, 0x38},
	{0x13, 0x0a},
...
static struct hi253_regval_list hi253_night_regs[]={
	{0x03,0x00}, 	
...
static struct hi253_regval_list hi253_sunset_regs[]={
	{0x03, 0x00}, 	
...
static struct hi253_regval_list  hi253_50hz_regs[]={
    /* 50 Hz */     
	{0x03,    0x20},	
	{0x10,    0x9c},
};

static struct hi253_regval_list  hi253_60hz_regs[]={
    /* 60 Hz */   
	{0x03,	  0x20},	
	{0x10,	  0x8c},	
};
