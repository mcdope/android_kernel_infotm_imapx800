...
#define INFOHEAD	"hi704_gaof_I:"
#define WARNHEAD	"hi704_gaof_W:"
#define ERRHEAD		"hi704_gaof_E:"
#define TIPHEAD		"hi704_gaof_T:"
...
typedef struct {
	...
	IM_INT32 bandMode;
	IM_INT32 sceneMode;
}hi704_gaof_context_t;

static hi704_gaof_context_t gHi704;
...
IM_RET hi704_gaof_pwdn(IM_UINT32 padNum)
{
...
IM_RET hi704_gaof_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_INT32 hi704_gaof_switch_vga(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
#if 0
...
IM_INT32 hi704_gaof_set_sepia(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
#if 1
...
IM_INT32 hi704_gaof_set_bluish(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_greenish(void){
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_yellowish(void){
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return 0;
}
IM_INT32 hi704_gaof_set_reddish(void){
#if 0
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_grayish(void){
#if 0
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_bandw(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_negative(void){
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_normal(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_auto(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_office(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_home(void){
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_sunny(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_cloudy(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_fluor(void){ 
#if 1
...
IM_RET hi704_gaof_sw_reset(void)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
    //Software Reset
...
IM_RET hi704_gaof_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
	...
	******************************/
    ...
    //Software Reset
	if(IM_RET_OK != hi704_gaof_sw_reset()){
		IM_ERRMSG((IM_STR("hi704_gaof software reset fail!")));
		return IM_RET_FAILED;
	}
	//read sensor id
	if(checkOnly == IM_TRUE)
	{
		...
		if(buf != 0x96)
		{
			IM_ERRMSG((IM_STR("hi704_gaof id error!")));
			return IM_RET_FAILED;
		}
		return IM_RET_OK;
	}
...
IM_RET hi704_gaof_start(void)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return IM_RET_OK;
}

IM_RET hi704_gaof_stop(void)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return ret;
}
IM_RET hi704_gaof_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_gaof_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_gaof_set_out_mode(camsen_out_mode_t *outMode)
{
	
	return IM_RET_OK;
}

IM_INT32 hi704_gaof_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	switch(value)
	{
		...
		case CAM_WB_MODE_FLUORESCENT:
			hi704_gaof_set_office();
			break;
		case CAM_WB_MODE_DAYLIGHT:
			hi704_gaof_set_sunny();
			break;
		case CAM_WB_MODE_CLOUDY_DAYLIGHT:
			hi704_gaof_set_cloudy();
			break;
...
IM_INT32 hi704_gaof_set_effect(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_gaof_set_exposure(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
    ...
    {
    case -4:
        hi704_write_cmos(0x40,0xe0);
        break;
    case -3:
        hi704_write_cmos(0x40,0xc8);
        break;
    case -2:
        hi704_write_cmos(0x40,0xb0);
        break;
    case -1:
        hi704_write_cmos(0x40,0x98);
        break;
    case 0:
        hi704_write_cmos(0x40,0x00);
        break;
    case 1:
        hi704_write_cmos(0x40,0x18);
        break;
    case 2:
        hi704_write_cmos(0x40,0x30);
        break;
    case 3:
        hi704_write_cmos(0x40,0x48);
        break;
    case 4:
        hi704_write_cmos(0x40,0x60);
        break;
    default:
        return IM_RET_FAILED;
    }
...
IM_INT32 hi704_gaof_set_night_mode(IM_BOOL enable)	
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_gaof_set_scene_mode(IM_INT32 value)
{
	IM_BOOL nightModeEn;
	...
	return hi704_gaof_set_night_mode(nightModeEn);
}

IM_INT32 hi704_gaof_set_antibanding(IM_INT32 value)
{
	IM_INT32 i = 0;
	IM_INT32 ret = 0;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_RET hi704_gaof_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		hi704_gaof_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		hi704_gaof_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		hi704_gaof_set_scene_mode(value);
	}
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		hi704_gaof_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		hi704_gaof_set_antibanding(value);
	}

	return ret;
}

IM_RET hi704_gaof_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops hi704_gaof_ops = {
	.name                   = "hi704_gaof",
	.i2c_dev_addr           = HI704_I2C_ADDR,

	.sen_pwdn				= hi704_gaof_pwdn,
	.sen_get_pmu_info		= hi704_gaof_get_pmu_info,
	.sen_init				= hi704_gaof_init,
	.sen_deinit				= hi704_gaof_deinit,
	.sen_start				= hi704_gaof_start,
	.sen_stop				= hi704_gaof_stop,
	.sen_get_caps			= hi704_gaof_get_caps,
	.sen_set_out_mode		= hi704_gaof_set_out_mode,
	.sen_get_out_mode		= hi704_gaof_get_out_mode,
	.sen_set_property		= hi704_gaof_set_property,
	.sen_get_property		= hi704_gaof_get_property,
};
