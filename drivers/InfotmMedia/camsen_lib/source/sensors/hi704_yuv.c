...
#define INFOHEAD	"HI704_YUV_I:"
#define WARNHEAD	"HI704_YUV_W:"
#define ERRHEAD		"HI704_YUV_E:"
#define TIPHEAD		"HI704_YUV_T:"
...
static hi704_yuv_context_t gHi704;
...
IM_RET hi704_yuv_pwdn(IM_UINT32 padNum)
{
...
IM_RET hi704_yuv_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_INT32 hi704_yuv_switch_vga(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
#if 0
...
IM_INT32 hi704_yuv_set_sepia(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
#if 1
...
IM_INT32 hi704_yuv_set_bluish(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_greenish(void){
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_yellowish(void){
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return 0;
}
IM_INT32 hi704_yuv_set_reddish(void){
#if 0
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_grayish(void){
#if 0
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_bandw(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_negative(void){
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_normal(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_auto(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_office(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_home(void){
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_sunny(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_cloudy(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_yuv_sw_reset(void)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
    //Software Reset
...
IM_RET hi704_yuv_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
	...
	******************************/
    ...
    //Software Reset
	if(IM_RET_OK != hi704_yuv_sw_reset()){
		IM_ERRMSG((IM_STR("hi704_yuv software reset fail!")));
		return IM_RET_FAILED;
	}
	//read sensor id
	if(checkOnly == IM_TRUE)
	{
		...
		if(buf != 0x96)
		{
			IM_ERRMSG((IM_STR("hi704_yuv id error!")));
			return IM_RET_FAILED;
		}
		return IM_RET_OK;
	}
...
IM_RET hi704_yuv_start(void)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return IM_RET_OK;
}

IM_RET hi704_yuv_stop(void)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return ret;
}
IM_RET hi704_yuv_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_yuv_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_yuv_set_out_mode(camsen_out_mode_t *outMode)
{
	
	return IM_RET_OK;
}

IM_INT32 hi704_yuv_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_effect(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi704_yuv_set_exposure(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_night_mode(IM_BOOL enable)	
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi704_yuv_set_scene_mode(IM_INT32 value)
{
	IM_BOOL nightModeEn;
	...
	return hi704_yuv_set_night_mode(nightModeEn);
}

IM_INT32 hi704_yuv_set_antibanding(IM_INT32 value)
{
	IM_INT32 i = 0;
	IM_INT32 ret = 0;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_RET hi704_yuv_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		hi704_yuv_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		hi704_yuv_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		hi704_yuv_set_scene_mode(value);
	}
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		hi704_yuv_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		hi704_yuv_set_antibanding(value);
	}

	return ret;
}

IM_RET hi704_yuv_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops hi704_yuv_ops = {
	.name                   = "hi704_yuv",
	.i2c_dev_addr           = HI704_I2C_ADDR,

	.sen_pwdn				= hi704_yuv_pwdn,
	.sen_get_pmu_info		= hi704_yuv_get_pmu_info,
	.sen_init				= hi704_yuv_init,
	.sen_deinit				= hi704_yuv_deinit,
	.sen_start				= hi704_yuv_start,
	.sen_stop				= hi704_yuv_stop,
	.sen_get_caps			= hi704_yuv_get_caps,
	.sen_set_out_mode		= hi704_yuv_set_out_mode,
	.sen_get_out_mode		= hi704_yuv_get_out_mode,
	.sen_set_property		= hi704_yuv_set_property,
	.sen_get_property		= hi704_yuv_get_property,
};
