...
#define INFOHEAD	"GT2005_PC4B_I:"
#define WARNHEAD	"GT2005_PC4B_W:"
#define ERRHEAD		"GT2005_PC4B_E:"
#define TIPHEAD		"GT2005_PC4B_T:"
...
typedef struct {
	...
	IM_INT32 bandMode;
	IM_INT32 sceneMode;
}gt2005_pc0am0004b_context_t;

static gt2005_pc0am0004b_context_t gGt2005;
...
IM_INT32 gt2005_pc0am0004b_svga_to_uxga(void){
	IM_UINT16 shutter = 0;		
...
IM_INT32 gt2005_pc0am0004b_switch_uxga(void){ 
	IM_INT32 i, ret;

	//gt2005_pc0am0004b_svga_to_uxga();
...
IM_INT32 gt2005_pc0am0004b_switch_svga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_switch_vga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_sepia(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_bluish(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_greenish(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_reddish(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_yellowish(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_bandw(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_negative(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_normal(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_auto(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_sunny(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_cloudy(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_office(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_home(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_effect(IM_INT32 value)
{
	...
	{                                        
		case CAM_SPECIAL_EFFECT_NONE:    
			gt2005_pc0am0004b_set_normal();   
			break;                   
		case CAM_SPECIAL_EFFECT_MONO:   
			gt2005_pc0am0004b_set_bandw();    
			break;                   
		case CAM_SPECIAL_EFFECT_NEGATIVE:  
			gt2005_pc0am0004b_set_negative(); 
			break;                   
		case CAM_SPECIAL_EFFECT_SOLARIZE:     
			gt2005_pc0am0004b_set_yellowish();
			break;                   
		case CAM_SPECIAL_EFFECT_PASTEL: 
			gt2005_pc0am0004b_set_reddish();  
			break;                   
		case CAM_SPECIAL_EFFECT_SEPIA:     
			gt2005_pc0am0004b_set_sepia();    
			break;                   
		case CAM_SPECIAL_EFFECT_POSTERIZE:   
			gt2005_pc0am0004b_set_bluish();   
			break;                   
		case CAM_SPECIAL_EFFECT_AQUA:         
			gt2005_pc0am0004b_set_greenish(); 
			break;                   
...
IM_INT32 gt2005_pc0am0004b_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
	...
	switch(value)
	{
		case CAM_WB_MODE_AUTO:
			gt2005_pc0am0004b_set_auto();
			break;
		case CAM_WB_MODE_INCANDESCENT:
			gt2005_pc0am0004b_set_home();
			break;
		case CAM_WB_MODE_FLUORESCENT:
			gt2005_pc0am0004b_set_office();
			break;
		case CAM_WB_MODE_DAYLIGHT:
			gt2005_pc0am0004b_set_sunny();
			break;
		case CAM_WB_MODE_CLOUDY_DAYLIGHT:
			gt2005_pc0am0004b_set_cloudy();
			break;
...
IM_INT32 gt2005_pc0am0004b_set_night_mode(IM_BOOL enable)
{
	IM_INT32 i, ret;
...
IM_INT32 gt2005_pc0am0004b_set_scene_mode(IM_INT32 value)
{
	...
	return gt2005_pc0am0004b_set_night_mode(nightModeEn);
}

IM_INT32 gt2005_pc0am0004b_set_exposure(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gt2005_pc0am0004b_set_antibanding(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
//======================================================
IM_RET gt2005_pc0am0004b_pwdn(IM_UINT32 padNum)
{
...
IM_RET gt2005_pc0am0004b_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_RET gt2005_pc0am0004b_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
...
IM_RET gt2005_pc0am0004b_deinit(void)
{
...
IM_RET gt2005_pc0am0004b_start(void)
{
	IM_INT32 ret;
...
IM_RET gt2005_pc0am0004b_stop(void)
{
	IM_INT32 ret;
...
IM_RET gt2005_pc0am0004b_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gt2005_pc0am0004b_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gt2005_pc0am0004b_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_UXGA)
	{
		ret = gt2005_pc0am0004b_switch_uxga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gt2005_pc0am0004b_switch_uxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_SVGA)
	{
		ret = gt2005_pc0am0004b_switch_svga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gt2005_pc0am0004b_switch_svga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_VGA)
	{
		ret = gt2005_pc0am0004b_switch_vga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gt2005_pc0am0004b_switch_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_RET gt2005_pc0am0004b_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		gt2005_pc0am0004b_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		gt2005_pc0am0004b_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		gt2005_pc0am0004b_set_scene_mode(value);
	}
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		gt2005_pc0am0004b_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		gt2005_pc0am0004b_set_antibanding(value);
	}

	return ret;
}

IM_RET gt2005_pc0am0004b_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops gt2005_pc0am0004b_ops = {
	.name                   = "gt2005_pc0am0004b",
	.i2c_dev_addr           = GT2005_I2C_ADDR,

	.sen_pwdn				= gt2005_pc0am0004b_pwdn,
	.sen_get_pmu_info		= gt2005_pc0am0004b_get_pmu_info,
	.sen_init				= gt2005_pc0am0004b_init,
	.sen_deinit				= gt2005_pc0am0004b_deinit,
	.sen_start				= gt2005_pc0am0004b_start,
	.sen_stop				= gt2005_pc0am0004b_stop,
	.sen_get_caps			= gt2005_pc0am0004b_get_caps,
	.sen_set_out_mode		= gt2005_pc0am0004b_set_out_mode,
	.sen_get_out_mode		= gt2005_pc0am0004b_get_out_mode,
	.sen_set_property		= gt2005_pc0am0004b_set_property,
	.sen_get_property		= gt2005_pc0am0004b_get_property,
};
