...
#define INFOHEAD	"hi253_HY_I:"
#define WARNHEAD	"hi253_HY_W:"
#define ERRHEAD		"hi253_HY_E:"
#define TIPHEAD		"hi253_HY_T:"
...
static hi253_hy_context_t gHi253;
...
IM_RET hi253_hy_pwdn(IM_UINT32 padNum)
{
...
IM_RET hi253_hy_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_INT32 hi253_hy_switch_uxga(void){ 
	IM_INT32 i, ret = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_switch_svga(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_switch_vga(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_sepia(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_bluish(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_greenish(void){
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_reddish(void){
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
#if 0
	IM_INT32 i, ret;
...
IM_INT32 hi253_hy_set_yellowish(void){
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return 0;
}
IM_INT32 hi253_hy_set_grayish(void){
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
#if 0
	IM_INT32 i, ret;
...
IM_INT32 hi253_hy_set_bandw(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_negative(void){
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_normal(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_auto(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_sunny(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_cloudy(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_office(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_home(void){ 
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_incande(void){ 
#if 1
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi253_hy_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
	...
	******************************/
	...
	msleep(5);
    //Software Reset
	if(IM_RET_OK != hi253_hy_sw_reset()){
		IM_ERRMSG((IM_STR("hi253_hy software reset fail!")));
		return IM_RET_FAILED;
	}
	//read sensor id
	if(checkOnly == IM_TRUE)
	{
		...
		if(buf != 0x92)
		{
			IM_ERRMSG((IM_STR("hi253_hy id error!")));
			return IM_RET_FAILED;
		}
		return IM_RET_OK;
	}
...
IM_RET hi253_hy_stop(void)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return ret;
}
IM_RET hi253_hy_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi253_hy_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi253_hy_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_UXGA)
	{
		ret = hi253_hy_switch_uxga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("hi253_hy_switch_uxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_SVGA)
	{
		ret =hi253_hy_switch_svga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("hi253_hy_switch_svga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_VGA)
	{
		...
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("hi253_hy_switch_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_INT32 hi253_hy_set_effect(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	switch(value)                            
	{                                        
		...
		case CAM_SPECIAL_EFFECT_NEGATIVE:  
			hi253_hy_set_negative(); 
			break;                   
		case CAM_SPECIAL_EFFECT_SOLARIZE:     
			hi253_hy_set_yellowish();
			break;                   
		case CAM_SPECIAL_EFFECT_PASTEL: 
			hi253_hy_set_reddish();  
			break;                   
...
IM_INT32 hi253_hy_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET hi253_hy_set_exposure(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
    ...
    case -3:
        ...
        break;
    case -2:
        hi253_write_cmos(0x40,0xa5);
        break;
    case -1:
        hi253_write_cmos(0x40,0x9a);
        break;
    case 0:
        hi253_write_cmos(0x40,0x8a);
        break;
    case 1:
...
IM_INT32 hi253_hy_set_night_mode(IM_BOOL enable)	
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_INT32 hi253_hy_set_scene_mode(IM_INT32 value)
{
	IM_BOOL nightModeEn;
	...
	return hi253_hy_set_night_mode(nightModeEn);
}

IM_INT32 hi253_hy_set_antibanding(IM_INT32 value)
{
	IM_INT32 i = 0;
	IM_INT32 ret = 0;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_RET hi253_hy_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		hi253_hy_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		hi253_hy_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		hi253_hy_set_scene_mode(value);
	}
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		hi253_hy_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		hi253_hy_set_antibanding(value);
	}

	return ret;
}

IM_RET hi253_hy_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops hi253_hy_ops = {
	.name                   = "hi253_hy",
	.i2c_dev_addr           = HI253_I2C_ADDR,

	.sen_pwdn				= hi253_hy_pwdn,
	.sen_get_pmu_info		= hi253_hy_get_pmu_info,
	.sen_init				= hi253_hy_init,
	.sen_deinit				= hi253_hy_deinit,
	.sen_start				= hi253_hy_start,
	.sen_stop				= hi253_hy_stop,
	.sen_get_caps			= hi253_hy_get_caps,
	.sen_set_out_mode		= hi253_hy_set_out_mode,
	.sen_get_out_mode		= hi253_hy_get_out_mode,
	.sen_set_property		= hi253_hy_set_property,
	.sen_get_property		= hi253_hy_get_property,
};
