...
#define INFOHEAD	"SP2518_500W_I:"
#define WARNHEAD	"SP2518_500W_W:"
#define ERRHEAD		"SP2518_500W_E:"
#define TIPHEAD		"SP2518_500W_T:"
...
IM_INT32 sp2518_500w_switch_uxga(void)
{ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_switch_svga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_switch_vga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_sepia(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_bluish(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_greenish(void){
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_reddish(void){
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_yellowish(void){
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_bandw(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_negative(void){
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_normal(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_auto(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_sunny(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_cloudy(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_office(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_home(void){ 
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_effect(IM_INT32 value)
{
...
IM_INT32 sp2518_500w_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 sp2518_500w_set_night_mode(IM_BOOL enable)
{
	IM_INT32 i, ret;
...
IM_INT32 sp2518_500w_set_scene_mode(IM_INT32 value)
{
	...
	return sp2518_500w_set_night_mode(nightModeEn);
}

IM_INT32 sp2518_500w_set_exposure(IM_INT32 value)
{
	IM_INT32 i,ret;
...
IM_INT32 sp2518_500w_set_antibanding(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
//------- for flashlight
IM_INT32 sp2518_500w_flash_on(IM_INT32 on)
{
...
IM_INT32 sp2518_500w_set_flash_mode(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 sp2518_500w_set_light_on(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
	...
	switch (value) {
	case 0:
        sp2518_500w_flash_on(0);
		break;
	case 1:
        sp2518_500w_flash_on(1);
		break;   
	default:
		return -1;
	}
...
//======================================================
IM_RET sp2518_500w_pwdn(IM_UINT32 padNum)
{
...
IM_RET sp2518_500w_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_RET sp2518_500w_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
...
IM_RET sp2518_500w_deinit(void)
{
...
IM_RET sp2518_500w_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET sp2518_500w_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET sp2518_500w_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET sp2518_500w_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		sp2518_500w_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		sp2518_500w_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		sp2518_500w_set_scene_mode(value);
	}
	//---- for flashlight
	else if(property == CAM_KEY_RW_FLASH_MODE)
	{
		sp2518_500w_set_flash_mode(value);
	}
	else if(property == CAM_KEY_RW_LIGHT_TURN_ON)
	{
		sp2518_500w_set_light_on(value);
	}
	//-------------
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		sp2518_500w_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		sp2518_500w_set_antibanding(value);
	}

	return ret;
}

IM_RET sp2518_500w_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops sp2518_500w_ops = {
	.name                   = "sp2518_500w",
	.i2c_dev_addr           = SP2518_I2C_ADDR,

	.sen_pwdn				= sp2518_500w_pwdn,
	.sen_get_pmu_info		= sp2518_500w_get_pmu_info,
	.sen_init				= sp2518_500w_init,
	.sen_deinit				= sp2518_500w_deinit,
	.sen_start				= sp2518_500w_start,
	.sen_stop				= sp2518_500w_stop,
	.sen_get_caps			= sp2518_500w_get_caps,
	.sen_set_out_mode		= sp2518_500w_set_out_mode,
	.sen_get_out_mode		= sp2518_500w_get_out_mode,
	.sen_set_property		= sp2518_500w_set_property,
	.sen_get_property		= sp2518_500w_get_property,
};
