...
#define INFOHEAD	"OV5640_FXN_I:"
#define WARNHEAD	"OV5640_FXN_W:"
#define ERRHEAD		"OV5640_FXN_E:"
#define TIPHEAD		"OV5640_FXN_T:"
...
typedef struct {
	...
	IM_INT32 light;
    IM_BOOL csiEn;
}ov5640_fxn_context_t;

static ov5640_fxn_context_t gOv5640;
...
IM_INT32 ov5640_fxn_set_auto(IM_INT32 value){ 
	IM_INT32 ret;
...
IM_INT32 ov5640_fxn_set_wb(IM_INT32 value)
{
    ...
    {
        return ov5640_fxn_set_auto(1);
    }

    ret = ov5640_fxn_set_auto(0);
    if(ret < 0) {
	...
	switch(value)
	{
		case CAM_WB_MODE_INCANDESCENT:
			ret = ov5640_fxn_set_incandescence();
			break;
		case CAM_WB_MODE_FLUORESCENT:
			ret = ov5640_fxn_set_fluorescent();
			break;
		case CAM_WB_MODE_DAYLIGHT:
			ret = ov5640_fxn_set_sunny();
			break;
		case CAM_WB_MODE_CLOUDY_DAYLIGHT:
			ret = ov5640_fxn_set_cloudy();
			break;
...
IM_INT32 ov5640_fxn_set_exposure(IM_INT32 value)
{
    IM_INT32 ret;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 ov5640_fxn_set_band_filter(IM_INT32 value)
{
	struct regval_list rReg;
	struct ov5640_regval_list wReg;
	IM_INT32 ret = 0;
...
IM_INT32 ov5640_fxn_flash_on(IM_INT32 on)
{
...
IM_INT32 ov5640_fxn_set_flash_mode(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 ov5640_fxn_set_light_on(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
	...
	switch (value) {
	case 0:
        ov5640_fxn_flash_on(0);
		break;
	case 1:
        ov5640_fxn_flash_on(1);
		break;   
	default:
		return -1;
	}
...
//======================================================
IM_RET ov5640_fxn_pwdn(IM_UINT32 padNum)
{
...
IM_RET ov5640_fxn_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET ov5640_fxn_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 ret;
	...
	IM_INFOMSG((IM_STR("%s(OV5640_Flash= %d)"), IM_STR(_IM_FUNC_), gOv5640.flashLight));

    //enable mipi csi
	if(checkOnly != IM_TRUE)
    {
		IM_ERRMSG((IM_STR("csilib_init() call!")));
        if(csilib_init(2, 224) != IM_RET_OK)
        {
            IM_ERRMSG((IM_STR("Failed to init csi lib!")));
            return IM_RET_FAILED;
        }

		IM_ERRMSG((IM_STR("csilib_open() call!")));
	...
	******************************/
	...
	//set POWER(1.5v enable)
	camsenpwl_io_set_mode(137, 1);
	//set io dir =0(output dir)
	camsenpwl_io_set_dir(137, 0);

	//set io outdata = 1(enable 1.5v)
	camsenpwl_io_set_outdat(137, 1);
	...
	******************************/
    ...
    /*ret = ov5640_fxn_set_band_filter(CAM_ANTIBANDING_MODE_50HZ);
    if(ret != 0)
    {
...
IM_RET ov5640_fxn_stop(void)
{
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return IM_RET_OK;
}

IM_RET ov5640_fxn_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET ov5640_fxn_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET ov5640_fxn_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret = 0;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_VGA)
	{
		ret = ov5640_fxn_to_vga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_SVGA)
	{
		ret = ov5640_fxn_to_svga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_svga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_XVGA)
	{
		ret = ov5640_fxn_to_xvga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_xvga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_720P)
	{
		ret = ov5640_fxn_to_720p(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_720p() failed!")));
			return IM_RET_FAILED;
		}
	}
	/*else if(res == CAM_RES_SXGA)
	{
		ret = ov5640_fxn_to_sxga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_sxga() failed!")));
			return IM_RET_FAILED;
		}
	}*/
	else if(res == CAM_RES_UXGA)
	{
		ret = ov5640_fxn_to_uxga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_uxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_1080P)
	{
		ret = ov5640_fxn_to_1080p(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_1080p() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_320W)
	{
		ret = ov5640_fxn_to_qxga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_qxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_500W)
	{
		ret = ov5640_fxn_to_qsxga(); 
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("ov5640_fxn_to_qsxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_RET ov5640_fxn_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		ov5640_fxn_set_wb(value);
	}
	/*else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		ov5640_fxn_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		ov5640_fxn_set_scene_mode(value);
	}*/
	else if(property == CAM_KEY_RW_FLASH_MODE)
	{
		ov5640_fxn_set_flash_mode(value);
	}
	else if(property == CAM_KEY_RW_LIGHT_TURN_ON)
	{
		ov5640_fxn_set_light_on(value);
	}
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		ov5640_fxn_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		ov5640_fxn_set_band_filter(value);
	}

	return ret;
}

IM_RET ov5640_fxn_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops ov5640_fxn_ops = {
	.name                   = "ov5640_fxn",
	.i2c_dev_addr           = OV5640_I2C_ADDR,

	.sen_pwdn				= ov5640_fxn_pwdn,
	.sen_get_pmu_info		= ov5640_fxn_get_pmu_info,
	.sen_init				= ov5640_fxn_init,
	.sen_deinit				= ov5640_fxn_deinit,
	.sen_start				= ov5640_fxn_start,
	.sen_stop				= ov5640_fxn_stop,
	.sen_get_caps			= ov5640_fxn_get_caps,
	.sen_set_out_mode		= ov5640_fxn_set_out_mode,
	.sen_get_out_mode		= ov5640_fxn_get_out_mode,
	.sen_set_property		= ov5640_fxn_set_property,
	.sen_get_property		= ov5640_fxn_get_property,
};
