...
typedef struct {
	...
	IM_INT32 bandMode;
	IM_INT32 sceneMode;
}gt2005_500w_context_t;

static gt2005_500w_context_t gGt2005;
...
IM_INT32 gt2005_500w_svga_to_uxga(void){
	IM_UINT16 shutter = 0;		
...
IM_INT32 gt2005_500w_switch_uxga(void){ 
	IM_INT32 i, ret;

	//gt2005_500w_svga_to_uxga();
...
IM_INT32 gt2005_500w_switch_svga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_switch_vga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_sepia(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_bluish(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_greenish(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_reddish(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_yellowish(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_bandw(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_negative(void){
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_normal(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_auto(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_sunny(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_cloudy(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_office(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_home(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_effect(IM_INT32 value)
{
...
IM_INT32 gt2005_500w_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gt2005_500w_set_night_mode(IM_BOOL enable)
{
	IM_INT32 i, ret;
...
IM_INT32 gt2005_500w_set_scene_mode(IM_INT32 value)
{
	...
	return gt2005_500w_set_night_mode(nightModeEn);
}

IM_INT32 gt2005_500w_set_exposure(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gt2005_500w_set_antibanding(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
//======================================================
IM_RET gt2005_500w_pwdn(IM_UINT32 padNum)
{
...
IM_RET gt2005_500w_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_RET gt2005_500w_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
...
IM_RET gt2005_500w_deinit(void)
{
...
IM_RET gt2005_500w_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gt2005_500w_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gt2005_500w_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_UXGA)
	{
		ret = gt2005_500w_switch_uxga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gt2005_500w_switch_uxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_SVGA)
	{
		ret = gt2005_500w_switch_svga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gt2005_500w_switch_svga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_VGA)
	{
		ret = gt2005_500w_switch_vga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gt2005_500w_switch_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_RET gt2005_500w_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		gt2005_500w_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		gt2005_500w_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		gt2005_500w_set_scene_mode(value);
	}
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		gt2005_500w_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		gt2005_500w_set_antibanding(value);
	}

	return ret;
}

IM_RET gt2005_500w_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops gt2005_500w_ops = {
	.name                   = "gt2005_500w",
	.i2c_dev_addr           = GT2005_I2C_ADDR,

	.sen_pwdn				= gt2005_500w_pwdn,
	.sen_get_pmu_info		= gt2005_500w_get_pmu_info,
	.sen_init				= gt2005_500w_init,
	.sen_deinit				= gt2005_500w_deinit,
	.sen_start				= gt2005_500w_start,
	.sen_stop				= gt2005_500w_stop,
	.sen_get_caps			= gt2005_500w_get_caps,
	.sen_set_out_mode		= gt2005_500w_set_out_mode,
	.sen_get_out_mode		= gt2005_500w_get_out_mode,
	.sen_set_property		= gt2005_500w_set_property,
	.sen_get_property		= gt2005_500w_get_property,
};
