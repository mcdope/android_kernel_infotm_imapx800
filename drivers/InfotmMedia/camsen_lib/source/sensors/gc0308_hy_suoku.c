...
#define INFOHEAD	"gc0308_hy_suoku_I:"
#define WARNHEAD	"gc0308_hy_suoku_W:"
#define ERRHEAD		"gc0308_hy_suoku_E:"
#define TIPHEAD		"gc0308_hy_suoku_T:"
...
typedef struct {
	...
	IM_INT32 bandMode;
	IM_INT32 sceneMode;
}gc0308_hy_suoku_context_t;

static gc0308_hy_suoku_context_t gGc0308;
...
int gc0308_hy_suoku_switch_qvga(void){ 
	int i, ret;
...
int gc0308_hy_suoku_switch_vga(void){ 
	int i, ret;
...
IM_INT32 gc0308_hy_suoku_set_sepia(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_bluish(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_greenish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_reddish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_yellowish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_bandw(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_negative(void){
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_normal(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_auto(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_sunny(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_cloudy(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_office(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_home(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_effect(IM_INT32 value)
{
	...
	{                                        
		case CAM_SPECIAL_EFFECT_NONE:    
			gc0308_hy_suoku_set_normal();   
			break;                   
		case CAM_SPECIAL_EFFECT_MONO:   
			gc0308_hy_suoku_set_bandw();    
			break;                   
		case CAM_SPECIAL_EFFECT_NEGATIVE:  
			gc0308_hy_suoku_set_negative(); 
			break;                   
		case CAM_SPECIAL_EFFECT_SOLARIZE:     
			gc0308_hy_suoku_set_yellowish();
			break;                   
		case CAM_SPECIAL_EFFECT_PASTEL: 
			gc0308_hy_suoku_set_reddish();  
			break;                   
		case CAM_SPECIAL_EFFECT_SEPIA:     
			gc0308_hy_suoku_set_sepia();    
			break;                   
		case CAM_SPECIAL_EFFECT_POSTERIZE:   
			gc0308_hy_suoku_set_bluish();   
			break;                   
		case CAM_SPECIAL_EFFECT_AQUA:         
			gc0308_hy_suoku_set_greenish(); 
			break;                   
...
IM_INT32 gc0308_hy_suoku_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
	...
	switch(value)
	{
		case CAM_WB_MODE_AUTO:
			gc0308_hy_suoku_set_auto();
			break;
		case CAM_WB_MODE_INCANDESCENT:
			gc0308_hy_suoku_set_home();
			break;
		case CAM_WB_MODE_FLUORESCENT:
			gc0308_hy_suoku_set_office();
			break;
		case CAM_WB_MODE_DAYLIGHT:
			gc0308_hy_suoku_set_sunny();
			break;
		case CAM_WB_MODE_CLOUDY_DAYLIGHT:
			gc0308_hy_suoku_set_cloudy();
			break;
...
IM_INT32 gc0308_hy_suoku_set_night_mode(IM_BOOL enable)
{
	IM_INT32 i, ret;
...
IM_INT32 gc0308_hy_suoku_set_scene_mode(IM_INT32 value)
{
	...
	return gc0308_hy_suoku_set_night_mode(nightModeEn);
}

IM_INT32 gc0308_hy_suoku_set_exposure(IM_INT32 value)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gc0308_hy_suoku_set_antibanding(IM_INT32 value)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
//======================================================
IM_RET gc0308_hy_suoku_pwdn(IM_UINT32 padNum)
{
	IM_TIPMSG((IM_STR("%s(GC0308_PWDN pad num= %d)"), IM_STR(_IM_FUNC_), padNum));
...
IM_RET gc0308_hy_suoku_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_INT32 gc0308_hy_suoku_repeat_init()
{
    IM_INT32 i, num = 0;
    IM_INT32 ret;
...
IM_RET gc0308_hy_suoku_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
    IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
	...
	******************************/
	...
	if(checkOnly == IM_TRUE)
	{
		...
		IM_TIPMSG((IM_STR("%s(GC0308_ID = 0x%x, real value is 0x9b)"), IM_STR(_IM_FUNC_), buf));
		if(buf != 0x9b)
		{
	...
	for(i = 0; i < (sizeof(gc0308_init_regs) / 2); i++)
	{
		...
		if(ret != 0)
		{
            ...
            if(gc0308_hy_suoku_repeat_init() != 0)
            {
                goto Fail;
            }
		}
...
IM_RET gc0308_hy_suoku_deinit(void)
{
...
IM_RET gc0308_hy_suoku_start(void)
{
	IM_INT32 i;
	IM_RET ret = IM_RET_OK;
...
IM_RET gc0308_hy_suoku_stop(void)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	return ret;
...
IM_RET gc0308_hy_suoku_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_suoku_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_suoku_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_VGA)
	{
		ret = gc0308_hy_suoku_switch_vga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc0308_hy_suoku_switch_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_QVGA)
	{
		ret = gc0308_hy_suoku_switch_qvga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc0308_hy_suoku_switch_qvga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_RET gc0308_hy_suoku_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc0308_hy_suoku_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops gc0308_hy_suoku_ops = {
	.name                   = "gc0308_hy_suoku",
	.i2c_dev_addr           = GC0308_I2C_ADDR,

	.sen_pwdn				= gc0308_hy_suoku_pwdn,
	.sen_get_pmu_info		= gc0308_hy_suoku_get_pmu_info,
	.sen_init				= gc0308_hy_suoku_init,
	.sen_deinit				= gc0308_hy_suoku_deinit,
	.sen_start				= gc0308_hy_suoku_start,
	.sen_stop				= gc0308_hy_suoku_stop,
	.sen_get_caps			= gc0308_hy_suoku_get_caps,
	.sen_set_out_mode		= gc0308_hy_suoku_set_out_mode,
	.sen_get_out_mode		= gc0308_hy_suoku_get_out_mode,
	.sen_set_property		= gc0308_hy_suoku_set_property,
	.sen_get_property		= gc0308_hy_suoku_get_property,
};
