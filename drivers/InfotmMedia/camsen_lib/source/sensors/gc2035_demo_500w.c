...
#define INFOHEAD	"GC2035_DEMO_500W_I:"
#define WARNHEAD	"GC2035_DEMO_500W_W:"
#define ERRHEAD		"GC2035_DEMO_500W_E:"
#define TIPHEAD		"GC2035_DEMO_500W_T:"
...
typedef struct {
	...
	IM_INT32 flashMode;
	IM_INT32 light;
}gc2035_demo_500w_context_t;

static gc2035_demo_500w_context_t gGc2035;
...
IM_INT32 gc2035_demo_500w_svga_to_uxga(void){
	IM_UINT16 shutter = 0;		
...
IM_INT32 gc2035_demo_500w_switch_uxga_before(void){
...
IM_INT32 gc2035_demo_500w_switch_uxga_after(void){
		IM_UINT16 shutter = 0;		
...
IM_INT32 gc2035_demo_500w_switch_uxga(void){ 
    	IM_INT32 i, ret;

	printk("%s:snake in.\n", __func__);
	
	//gc2035_svga_to_uxga();	
	gc2035_demo_500w_switch_uxga_before();	
	...
	gc2035_demo_500w_switch_uxga_after();
	return 0; 
}

IM_INT32 gc2035_demo_500w_switch_svga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_switch_vga(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_sepia(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_bluish(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_greenish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_reddish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_yellowish(void){
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_bandw(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_negative(void){
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_normal(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_auto(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_sunny(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_cloudy(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_office(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_home(void){ 
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_effect(IM_INT32 value)
{
	...
	{                                        
		case CAM_SPECIAL_EFFECT_NONE:    
			gc2035_demo_500w_set_normal();   
			break;                   
		case CAM_SPECIAL_EFFECT_MONO:   
			gc2035_demo_500w_set_bandw();    
			break;                   
		case CAM_SPECIAL_EFFECT_NEGATIVE:  
			gc2035_demo_500w_set_negative(); 
			break;                   
		case CAM_SPECIAL_EFFECT_SOLARIZE:     
			gc2035_demo_500w_set_yellowish();
			break;                   
		case CAM_SPECIAL_EFFECT_PASTEL: 
			gc2035_demo_500w_set_reddish();  
			break;                   
		case CAM_SPECIAL_EFFECT_SEPIA:     
			gc2035_demo_500w_set_sepia();    
			break;                   
		case CAM_SPECIAL_EFFECT_POSTERIZE:   
			gc2035_demo_500w_set_bluish();   
			break;                   
		case CAM_SPECIAL_EFFECT_AQUA:         
			gc2035_demo_500w_set_greenish(); 
			break;                   
...
IM_INT32 gc2035_demo_500w_set_wb(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
	...
	switch(value)
	{
		case CAM_WB_MODE_AUTO:
			gc2035_demo_500w_set_auto();
			break;
		case CAM_WB_MODE_INCANDESCENT:
			gc2035_demo_500w_set_home();
			break;
		case CAM_WB_MODE_FLUORESCENT:
			gc2035_demo_500w_set_office();
			break;
		case CAM_WB_MODE_DAYLIGHT:
			gc2035_demo_500w_set_sunny();
			break;
		case CAM_WB_MODE_CLOUDY_DAYLIGHT:
			gc2035_demo_500w_set_cloudy();
			break;
...
IM_INT32 gc2035_demo_500w_set_night_mode(IM_BOOL enable)
{
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_scene_mode(IM_INT32 value)
{
	IM_BOOL nightModeEn;
	...
	return gc2035_demo_500w_set_night_mode(nightModeEn);
}

IM_INT32 gc2035_demo_500w_set_exposure(IM_INT32 value)
{
	IM_INT32 i, ret;
...
IM_INT32 gc2035_demo_500w_set_antibanding(IM_INT32 value)
{
	IM_INT32 i, ret;
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
//------- for flashlight
IM_INT32 gc2035_demo_500w_flash_on(IM_INT32 on)
{
...
IM_INT32 gc2035_demo_500w_set_flash_mode(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
...
IM_INT32 gc2035_demo_500w_set_light_on(IM_INT32 value)
{
	IM_INFOMSG((IM_STR("%s(value = %d)"), IM_STR(_IM_FUNC_), value));
	...
	switch (value) {
	case 0:
        gc2035_demo_500w_flash_on(0);
		break;
	case 1:
        gc2035_demo_500w_flash_on(1);
		break;   
	default:
		return -1;
	}
...
//======================================================
IM_RET gc2035_demo_500w_pwdn(IM_UINT32 padNum)
{
...
IM_RET gc2035_demo_500w_get_pmu_info(camsenpwl_pmu_info_t *pmuInfo)
{
...
IM_RET gc2035_demo_500w_init(pwl_handle_t pwl, IM_BOOL checkOnly)
{
	IM_INT32 i, ret;
	IM_CHAR buf = 0;
	IM_INFOMSG((IM_STR("%s()++"), IM_STR(_IM_FUNC_)));
...
IM_RET gc2035_demo_500w_deinit(void)
{
...
IM_RET gc2035_demo_500w_start(void)
{
	//IM_INT32 ret;
...
IM_RET gc2035_demo_500w_stop(void)
{
	//IM_INT32 ret;
...
IM_RET gc2035_demo_500w_get_caps(camsen_caps_t *caps)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc2035_demo_500w_get_out_mode(camsen_out_mode_t *outMode)
{
	IM_RET ret = IM_RET_OK;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
IM_RET gc2035_demo_500w_set_out_mode(camsen_out_mode_t *outMode)
{
	IM_INT32 ret;
	IM_UINT32 res, fps;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	if(res == CAM_RES_UXGA)
	{
		ret = gc2035_demo_500w_switch_uxga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc2035_demo_500w_switch_uxga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_SVGA)
	{
		ret = gc2035_demo_500w_switch_svga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc2035_demo_500w_switch_svga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else if(res == CAM_RES_VGA)
	{
		ret = gc2035_demo_500w_switch_vga();
		if(ret != 0)
		{
			IM_ERRMSG((IM_STR("gc2035_demo_500w_switch_vga() failed!")));
			return IM_RET_FAILED;
		}
	}
	else
...
IM_RET gc2035_demo_500w_set_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
	...
	{
		gc2035_demo_500w_set_wb(value);
	}
	else if(property == CAM_KEY_RW_SPECIAL_EFFECT)
	{
		gc2035_demo_500w_set_effect(value);
	}
	else if(property == CAM_KEY_RW_SCENE_MODE)
	{
		gc2035_demo_500w_set_scene_mode(value);
	}
	//---- for flashlight
	else if(property == CAM_KEY_RW_FLASH_MODE)
	{
		gc2035_demo_500w_set_flash_mode(value);
	}
	else if(property == CAM_KEY_RW_LIGHT_TURN_ON)
	{
		gc2035_demo_500w_set_light_on(value);
	}
	//-------------
	else if(property == CAM_KEY_RW_EXPOSURE_COMPENSATION)
	{
		gc2035_demo_500w_set_exposure(value);
	}
	else if(property == CAM_KEY_RW_ANTIBANDING_MODE)
	{
		gc2035_demo_500w_set_antibanding(value);
	}

	return ret;
}

IM_RET gc2035_demo_500w_get_property(IM_UINT32 property, void *p)
{
	IM_RET ret = IM_RET_OK;
	IM_INT32 value = 0;
	IM_INFOMSG((IM_STR("%s()"), IM_STR(_IM_FUNC_)));
...
camsen_ops gc2035_demo_500w_ops = {
	.name                   = "gc2035_demo_500w",
	.i2c_dev_addr           = gc2035_I2C_ADDR,

	.sen_pwdn				= gc2035_demo_500w_pwdn,
	.sen_get_pmu_info		= gc2035_demo_500w_get_pmu_info,
	.sen_init				= gc2035_demo_500w_init,
	.sen_deinit				= gc2035_demo_500w_deinit,
	.sen_start				= gc2035_demo_500w_start,
	.sen_stop				= gc2035_demo_500w_stop,
	.sen_get_caps			= gc2035_demo_500w_get_caps,
	.sen_set_out_mode		= gc2035_demo_500w_set_out_mode,
	.sen_get_out_mode		= gc2035_demo_500w_get_out_mode,
	.sen_set_property		= gc2035_demo_500w_set_property,
	.sen_get_property		= gc2035_demo_500w_get_property,
};
