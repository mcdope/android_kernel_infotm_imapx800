...
static const IM_UINT16 AUD_BASE_ADDR = 0x3100;
static const IM_UINT16 AG_BASE_ADDR = 0x7100;
/* interface offset*/
static const IM_UINT16 AUDIO_I2S   = 0x0000;
static const IM_UINT16 AUDIO_CLOCK = 0x0100;
static const IM_UINT16 AUDIO_SPDIF = 0x0200;
static const IM_UINT16 AUDIO_HBR   = 0x0300;
static const IM_UINT16 AUDIO_GPA   = 0x0400;
/* bit shifts */
static const IM_UINT8 VALIDITY_BIT = 1;
static const IM_UINT8 USER_BIT = 0;
...
IM_INT32 audio_Configure(IM_UINT16 baseAddr, audioParams_t *params, IM_UINT16 pixelClk, IM_UINT32 ratioClk)
{
	...
	halAudioI2s_Select(baseAddr + AUD_BASE_ADDR + AUDIO_I2S, (audioParams_GetInterfaceType(params) == I2S)? 1 : 0);
 	...
 	halAudioSpdif_InterruptMask(baseAddr + AUD_BASE_ADDR + AUDIO_SPDIF, 3); // sam : 0x3302 reserved and read as zero.
 	halAudioSpdif_InterruptPolarity(baseAddr + AUD_BASE_ADDR + AUDIO_SPDIF, 3);// sam : 0x3302 reserved and read as zero.
	...
	if (audioParams_GetInterfaceType(params) != GPA)
	{
		switch (audioParams_GetClockFsFactor(params))
		{
			 ...
			 */
			case 64:
				//sam : Now support dru bypass controller ? 
				/*
...
/*sam : 0x7000+ controller register not used any more.
