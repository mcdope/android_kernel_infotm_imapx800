...
void log_SetVerboseWrite(IM_UINT32 state);

void log_PrintWrite(IM_UINT32 a, IM_UINT32 b);
...
void log_Print3(verbose_t verbose, const char* functionName, const char* a,
		IM_UINT32 b, IM_UINT32 c);

void log_PrintInt(verbose_t verbose, const char* functionName, IM_UINT32 a);

void log_PrintInt2(verbose_t verbose, const char* functionName, IM_UINT32 a,
		IM_UINT32 b);
...
#define LOG_WARNING2(a, b)	
#define LOG_WARNING3(a, b, c)	
#define LOG_NOTICE(a)		
#define LOG_NOTICE2(a, b)		
...
#define LOG_MENU(a)			
#define LOG_MENUSTR(a, b)	
#define LOG_MENUINT(a, b)	
#define LOG_MENUINT2(a, b, c)
#endif
