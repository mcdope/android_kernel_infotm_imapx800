...
{
		/** VIC code */
//	params->mDtd = *dtd; //sam : may cause the error result . So modify it.
	params->mDtd.mCode = dtd->mCode;
	params->mDtd.mPixelRepetitionInput = dtd->mPixelRepetitionInput;
	params->mDtd.mPixelClock = dtd->mPixelClock;
	params->mDtd.mInterlaced = dtd->mInterlaced;
	params->mDtd.mHActive = dtd->mHActive;
	params->mDtd.mHBlanking = dtd->mHBlanking;
	params->mDtd.mHBorder = dtd->mHBorder;
	params->mDtd.mHImageSize = dtd->mHImageSize;
	params->mDtd.mHSyncOffset = dtd->mHSyncOffset;
	params->mDtd.mHSyncPulseWidth = dtd->mHSyncPulseWidth;
	params->mDtd.mHSyncPolarity = dtd->mHSyncPolarity;
	params->mDtd.mVActive = dtd->mVActive;
	params->mDtd.mVBlanking = dtd->mVBlanking;
	params->mDtd.mVBorder = dtd->mVBorder;
	params->mDtd.mVImageSize = dtd->mVImageSize;
	params->mDtd.mVSyncOffset = dtd->mVSyncOffset;
	params->mDtd.mVSyncPulseWidth = dtd->mVSyncPulseWidth;
	params->mDtd.mVSyncPulseWidth = dtd->mVSyncPulseWidth;
	params->mDtd.mVSyncPolarity = dtd->mVSyncPolarity;
