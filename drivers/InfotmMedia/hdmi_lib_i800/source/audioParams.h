...
typedef struct
{
	...
	IM_UINT8 mLevelShiftValue; /** level shift value (audioParams_t *params, 
						 see InfoFrame) */

	IM_UINT8 mDownMixInhibitFlag; /** down-mix inhibit flag (audioParams_t *params, 
							see InfoFrame) */

	IM_UINT32 mOriginalSamplingFrequency; /** Original sampling frequency */

	IM_UINT8 mIecCopyright; /** IEC copyright */

	IM_UINT8 mIecCgmsA; /** IEC CGMS-A */

	IM_UINT8 mIecPcmMode; /** IEC PCM mode */

	IM_UINT8 mIecCategoryCode; /** IEC category code */

	IM_UINT8 mIecSourceNumber; /** IEC source number */

	IM_UINT8 mIecClockAccuracy; /** IEC clock accuracy */ 
 ...
 */
IM_UINT8 audioParams_GetChannelAllocation(audioParams_t *params);
/**
 * Set the audio channels' set up
 * @param params pointer to the audio parameters structure
 * @param value code of the channel allocation from Table 20 in CEA-861-D
 */
void audioParams_SetChannelAllocation(audioParams_t *params, IM_UINT8 value);
/**
 * @param params pointer to the audio parameters structure
 * @return the audio coding type of audio stream
 */
IM_UINT8 audioParams_GetCodingType(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 ...
 */
IM_UINT8 audioParams_GetDownMixInhibitFlag(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value 1 if the Down Mix Inhibit is allowed, 0 otherwise
 */
void audioParams_SetDownMixInhibitFlag(audioParams_t *params, IM_UINT8 value);
/**
 ...
 */
IM_UINT8 audioParams_GetIecCategoryCode(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value the IEC audio category code
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetIecCategoryCode(audioParams_t *params, IM_UINT8 value);
/**
 ...
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT8 audioParams_GetIecCgmsA(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value the IEC CGMS-A code
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetIecCgmsA(audioParams_t *params, IM_UINT8 value);
/**
 * @param params pointer to the audio parameters structure
 * @return the audio clock accuracy
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT8 audioParams_GetIecClockAccuracy(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value the audio clock accuracy
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetIecClockAccuracy(audioParams_t *params, IM_UINT8 value);
/**
 * @param params pointer to the audio parameters structure
 * @return 1 if IEC Copyright is enable
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT8 audioParams_GetIecCopyright(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value 1 if IEC Copyright enable, 0 otherwise
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetIecCopyright(audioParams_t *params, IM_UINT8 value);
/**
 * @param params pointer to the audio parameters structure
 * @return the IEC PCM audio mode (audioParams_t *params, pre-emphasis)
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT8 audioParams_GetIecPcmMode(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value the IEC PCM audio mode (audioParams_t *params, pre-emphasis)
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetIecPcmMode(audioParams_t *params, IM_UINT8 value);
/**
 * @param params pointer to the audio parameters structure
 * @return the IEC Source Number
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT8 audioParams_GetIecSourceNumber(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value the IEC Source Number
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetIecSourceNumber(audioParams_t *params, IM_UINT8 value);
/**
 ...
 */
IM_UINT8 audioParams_GetLevelShiftValue(audioParams_t *params);

void audioParams_SetLevelShiftValue(audioParams_t *params, IM_UINT8 value);
/**
 ...
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT32 audioParams_GetOriginalSamplingFrequency(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value a 32-bit word original sampling frequency
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetOriginalSamplingFrequency(audioParams_t *params, IM_UINT32 value);
/**
 * @param params pointer to the audio parameters structure
 * @return 8-bit sample size in bits
 */
IM_UINT8 audioParams_GetSampleSize(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @param value 8-bit sample size in bits
 */
void audioParams_SetSampleSize(audioParams_t *params, IM_UINT8 value);
/**
 ...
 * @note when trasnmitting L-PCM on I2S
 */
IM_UINT32 audioParams_GetSamplingFrequency(audioParams_t *params);
/**
 * 192000 Hz| 176400 Hz| 96000 Hz| 88200 Hz| 48000 Hz| 44100 Hz| 32000 Hz
 * @param params pointer to the audio parameters structure
 ...
 * @note when trasnmitting L-PCM on I2S
 */
void audioParams_SetSamplingFrequency(audioParams_t *params, IM_UINT32 value);
/**
 * [Hz]
 * @param params pointer to the audio parameters structure
 * @return audio clock in Hz
 */
IM_UINT32 audioParams_AudioClock(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @return number of audio channels transmitted -1
 */
IM_UINT8 audioParams_ChannelCount(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 */
IM_UINT8 audioParams_IecOriginalSamplingFrequency(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 */
IM_UINT8 audioParams_IecSamplingFrequency(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 */
IM_UINT8 audioParams_IecWordLength(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 * @return 1 if it is linear PCM
 */
IM_UINT8 audioParams_IsLinearPCM(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 ...
 */
IM_UINT8 audioParams_IsChannelEn(audioParams_t *params, IM_UINT8 channel);
/**
 * @param params pointer to the audio parameters structure
 * @return the input audio clock Fs factor
 */
IM_UINT16 audioParams_GetClockFsFactor(audioParams_t *params);
/**
 * @param params pointer to the audio parameters structure
 ...
 * @return the input audio clock fs factor
 */
void audioParams_SetClockFsFactor(audioParams_t *params, IM_UINT16 clockFsFactor);
