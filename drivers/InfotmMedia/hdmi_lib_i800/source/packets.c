...
{
	IM_UINT8 newFields[ACP_PACKET_SIZE];
	IM_UINT16 i = 0;
	LOG_TRACE();
...
{
	IM_UINT16 i = 0;
	IM_UINT8 newCodes[ISRC_PACKET_SIZE * 2];
	LOG_TRACE();
...
{
	const IM_UINT16 pSize = 8;
	const IM_UINT16 vSize = 16;
...
{
	IM_UINT16 endTop = 0;
	IM_UINT16 startBottom = 0;
	IM_UINT16 endLeft = 0;
	IM_UINT16 startRight = 0;
	LOG_TRACE();
	...
	{
		IM_UINT8 pic = (dtd_GetHImageSize(videoParams_GetDtd(videoParams)) * 10)
