...
int ov2655_xyc_reset(void __iomem *reg)
{
	uint32_t tmp = 0;
 ...
 */
 ...
 int imapx_cam_start(void){
	int i, ret; 

	printk(KERN_INFO "imapx_cam_start\n");
...
int imapx_cam_close(void)
{
	int i, ret;
	printk(KERN_INFO "imapx_cam_close\n");	
 ...
 */
	 ...
	 */
int  imapx_cam_switch_low_svga(void)
{
	int i, ret;	

	printk(KERN_INFO "imapx_cam_switch_low_svga\n");	
	 ...
	 */
int  imapx_cam_switch_high_svga(void)
{
	int i, ret;

	printk(KERN_INFO "imapx_cam_switch_high_svga\n");	
  ...
  * 1600x1200
  */
int  imapx_cam_switch_high_xuga(void)
{
	int i, ret;
 ...
 * 1280x960
 */
int imapx_cam_switch_upmid_xuga(void)
{
	int i, ret;
 ...
 * 800x600
 */
int  imapx_cam_switch_mid_xuga(void)
{
	int i, ret;
...
int  imapx_cam_switch_low_xuga(void)
{
	int i, ret;
...
int imapx_cam_svga_to_xuga(void){
	int i, ret;
	char gain = 0;
...
int imapx_cam_to_preview_320_240(void)
{
	int i, ret;
	char reg0x3013;
...
int imapx_cam_to_preview_640_480(void)
{
	int i, ret;
	char reg0x3013;
	struct ov2655_regval_list ov2655_3013[] = {
...
int imapx_cam_saturation_0(void)
{ 
	int i, ret; 
...
int imapx_cam_saturation_1(void)
{ 
	int i, ret; 
...
int imapx_cam_saturation_2(void)
{ 
	int i, ret; 
...
int imapx_cam_saturation_3(void)
{ 
	int i, ret; 
...
int imapx_cam_saturation_4(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_0(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_1(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_2(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_3(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_4(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_5(void)
{ 
	int i, ret; 
...
int imapx_cam_brightness_6(void)
{ 
	int i, ret; 
...
int imapx_cam_sharpness_0(void)
{ 
	int i, ret; 
...
int imapx_cam_sharpness_1(void)
{ 
	int i, ret; 
...
int imapx_cam_sharpness_2(void)
{ 
	int i, ret; 
...
int imapx_cam_sharpness_3(void)
{ 
	int i, ret; 
...
int imapx_cam_sharpness_4(void)
{ 
	int i, ret; 
...
int imapx_cam_sharpness_auto(void)
{ 
	int i, ret; 
...
int imapx_cam_night_mode_on(void)
{ 
	int i, ret; 
...
int imapx_cam_night_mode_off(void)
{ 
	int i, ret; 
...
int ov2655_xyc_set_mode(int value, void __iomem *reg)
{
	int ret;
	...
	switch(value)
	{
		...
		case SWITCH_SENSOR_TO_HIGH_SVGA:
			ret = imapx_cam_switch_high_svga();
			break;

		case SWITCH_SENSOR_TO_LOW_SVGA:
			ret = imapx_cam_switch_low_svga();
			break;

		case SWITCH_SENSOR_TO_HIGH_XUGA:
			ret = imapx_cam_svga_to_xuga();
			ret = imapx_cam_switch_high_xuga();
			break;

		case SWITCH_SENSOR_TO_UPMID_XUGA:
			ret = imapx_cam_svga_to_xuga();
			ret = imapx_cam_switch_upmid_xuga();
			break;

		case SWITCH_SENSOR_TO_MID_XUGA:
			ret = imapx_cam_svga_to_xuga();
			ret = imapx_cam_switch_mid_xuga();
			break;

		case SWITCH_SENSOR_TO_LOW_XUGA:
			ret = imapx_cam_switch_low_xuga();
			break;

		case SENSOR_TO_HIGH_PREVIEW:
			ret = imapx_cam_to_preview_640_480();
			break;

		case SENSOR_TO_LOW_PREVIEW:
			ret = imapx_cam_to_preview_320_240();
			break;
		case CLOSE_SENSOR:
			ret = imapx_cam_close();
			break;
...
static struct res_to_fps_map ov2655_xyc_rf_maps[3] = {
	{
...
static uint32_t ov2655_xyc_get_fps(uint32_t res)
{
	int i = 0;
	uint32_t fps = 0;
	...
	for ( ; i < (sizeof(ov2655_xyc_rf_maps) / sizeof(ov2655_xyc_rf_maps[0])); 
			i++) {
		if (ov2655_xyc_rf_maps[i].res == res) {
			fps = ov2655_xyc_rf_maps[i].fps;
			break;
		}
	}
