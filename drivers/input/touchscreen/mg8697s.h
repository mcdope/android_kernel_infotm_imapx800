...
/* zhongwei add for changing tp mode 2012/12/10 */
//#define Simple_MODE	1

#if 0 //by junery
#if Simple_MODE
/* Simple 2012/11/10 zhongwei changed*/
#define CAP_X_CORD 	  1151 //0x0380
#define CAP_Y_CORD 	   703//0x0240
#else 
/* HD 2012/11/10 zhongwei changed*/
#define CAP_X_CORD 	  1087 //0x0380
#define CAP_Y_CORD 	  703//0x0240
#endif //Simple_MODE
/* end */
#endif
...
enum mg_key_code {
	...
	MG_ANDROID_BACK,
	MG_ANDROID_MENU,
	MG_ANDROID_4_RESERVED,
	MG_ANDROID_CALL,
	MG_ANDROID_6_RESERVED,
	MG_ANDROID_VOL_UP,
	MG_ANDROID_VOL_DOWN,
};
