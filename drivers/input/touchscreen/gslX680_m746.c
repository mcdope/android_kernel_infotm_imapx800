...
#define STK_ACC_CALI_FILE  "/data/misc/dmt/stk_acc_cali.conf"
*/
...
static int gsl_ts_init_ts(struct i2c_client *client, struct gsl_ts *ts)
{
	...
	//imapx_pad_irq_config(tsp_irq_index, INTTYPE_RISING, FILTER_MAX);/* set trigger mode and filter */
...
// Set segment descriptor associated to kernel space
	set_fs(KERNEL_DS);
 cali_file = sys_open(STK_ACC_CALI_FILE,O_WRONLY|O_CREAT, 0777);

if(cali_file<0)
{
        printk(KERN_ERR "%s: filp_open error, no offset file!...................................ttttttttttttttttttt\n", __func__);
}
*/
...
static void gsl_ts_resume_async_work(struct work_struct *work)
{
  	printk("I'am in gsl_ts_resume() start.1\n");
...
/**********************************************/
	...
	rc=  request_irq(client->irq, gsl_ts_irq, IRQF_SHARED, client->name, ts);
...
static int __init gsl_ts_init(void)
{
	...
	{
		if(item_equal("ts.model", "m746gslx680", 0))
		{
...
/**********************************************/
			...
			printk(KERN_ERR "%s: touchscreen is not gslX680\n", __func__);
	}
	else
