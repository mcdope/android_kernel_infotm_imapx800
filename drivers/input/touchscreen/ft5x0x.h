...
#define CFG_DBG_DUMMY_INFO_SUPPORT   0     //output touch point information
#define CFG_DBG_FUCTION_INFO_SUPPORT 0     //output fouction name
#define CFG_DBG_INPUT_EVENT          0     //debug input event

#if CFG_DBG_DUMMY_INFO_SUPPORT
#define DBG_DUMMY(x...) printk(x)
#else
#define DBG_DUMMY(x...)
#endif

#if CFG_DBG_FUCTION_INFO_SUPPORT
#define DBG_FUNC(x...) printk(x)
#else
#define DBG_FUNC(x...)
#endif

#if CFG_DBG_INPUT_EVENT
#define DBG_EVENT(x...) printk(x)
#else
#define DBG_EVENT(x...)
#endif
