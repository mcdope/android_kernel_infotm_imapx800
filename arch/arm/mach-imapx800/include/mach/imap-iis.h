...
#define rI2S_MCLKDIV             (0x20003004) //Mclk Configuration Register
#define rI2S_BCLKDIV             (0x20003008) //Bclk Configuration Register
#define rI2S_INTERFACE			 (0x20003000) //master module cfg data from iis0 interface
/* useless */
